...
module AsyncQueueSink_8(
  ...
  wire [81:0] _io_deq_bits_deq_bits_reg_io_q;
  ...
  ClockCrossingReg_w82 io_deq_bits_deq_bits_reg (
    .clock (clock),
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[81:79];
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[78:77];
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[76:73];
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[72:69];
