...
module TLMonitor_17(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      if (_GEN_0 & ~({io_in_a_bits_address[27:14], ~(io_in_a_bits_address[13:12])} == 16'h0 | io_in_a_bits_address[27:13] == 15'h0 | {io_in_a_bits_address[27:21], io_in_a_bits_address[20:17] ^ 4'h8, io_in_a_bits_address[15:12]} == 15'h0 | {io_in_a_bits_address[27:26], io_in_a_bits_address[25:16] ^ 10'h200} == 12'h0 | {io_in_a_bits_address[27:26], io_in_a_bits_address[25:12] ^ 14'h2010} == 16'h0 | (&(io_in_a_bits_address[27:26])))) begin
