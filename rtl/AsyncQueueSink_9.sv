...
module AsyncQueueSink_9(
  ...
  input  [27:0] io_async_mem_0_address,
  ...
  input  [6:0]  io_async_mem_1_source,
  input  [27:0] io_async_mem_1_address,
  ...
  input  [6:0]  io_async_mem_2_source,
  input  [27:0] io_async_mem_2_address,
  ...
  input  [6:0]  io_async_mem_3_source,
  input  [27:0] io_async_mem_3_address,
  ...
  input  [6:0]  io_async_mem_4_source,
  input  [27:0] io_async_mem_4_address,
  ...
  input  [6:0]  io_async_mem_5_source,
  input  [27:0] io_async_mem_5_address,
  ...
  input  [6:0]  io_async_mem_6_source,
  input  [27:0] io_async_mem_6_address,
  ...
  input  [6:0]  io_async_mem_7_source,
  input  [27:0] io_async_mem_7_address,
  ...
  wire [117:0] _io_deq_bits_deq_bits_reg_io_q;
  ...
  ClockCrossingReg_w118 io_deq_bits_deq_bits_reg (
    .clock (clock),
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[117:115];
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[114:112];
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[111:108];
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[107:101];
  assign io_deq_bits_address = _io_deq_bits_deq_bits_reg_io_q[100:73];
