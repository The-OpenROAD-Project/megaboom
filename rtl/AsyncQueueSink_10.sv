...
module AsyncQueueSink_10(
  ...
  wire [118:0] _io_deq_bits_deq_bits_reg_io_q;
  ...
  ClockCrossingReg_w119 io_deq_bits_deq_bits_reg (
    .clock (clock),
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[118:116];
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[115:113];
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[112:110];
