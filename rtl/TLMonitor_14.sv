  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_44 ? 16'h1 << _GEN_2 : 16'h0) | a_set_wo_ready == 16'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 7 (connected at generators/testchipip/src/main/scala/serdes/PeripheryTLSerial.scala:138:77)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
