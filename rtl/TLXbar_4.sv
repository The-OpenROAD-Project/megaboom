...
module TLXbar_4(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 8'h80;
  wire        portsDIO_filtered_0_valid = auto_out_d_valid & ~(auto_out_d_bits_source[7]);
  ...
  TLMonitor_16 monitor (
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[6:0]),
  ...
  assign auto_out_a_bits_source = (muxState_0 ? {1'h0, auto_in_0_a_bits_source} : 8'h0) | {muxState_1, 7'h0};
  assign auto_out_a_bits_address = (muxState_0 ? auto_in_0_a_bits_address : 28'h0) | (muxState_1 ? auto_in_1_a_bits_address : 28'h0);
  ...
  assign auto_out_d_ready = ~(auto_out_d_bits_source[7]) & auto_in_0_d_ready | requestDOI_0_1;
endmodule
