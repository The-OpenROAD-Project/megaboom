...
module TLMonitor_52(
  ...
  `ifndef SYNTHESIS
    ...
    wire [2063:0] _GEN_28 = {2052'h0, io_in_d_bits_source};
    ...
    wire [2063:0] _GEN_33 = inflight >> io_in_a_bits_source;
    wire [2063:0] _GEN_34 = inflight >> _GEN_28;
    wire [8255:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN;
    wire [4095:0] _d_clr_wo_ready_T = 4096'h1 << _GEN_2;
    wire [2063:0] _GEN_35 = inflight_1 >> _GEN_28;
    ...
    always @(posedge clock) begin
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_27 ? _d_clr_wo_ready_T[2063:0] : 2064'h0) | a_set_wo_ready == 2064'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [32782:0] _d_sizes_clr_T_11 = 32783'hF << _GEN_36;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[2063:0] : 2064'h0)) & ~(_GEN_37 ? _d_clr_T[2063:0] : 2064'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_37 ? _d_opcodes_clr_T_5[8255:0] : 8256'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_37 ? _d_sizes_clr_T_5[8255:0] : 8256'h0);
      ...
      inflight_1 <= inflight_1 & ~(_GEN_38 ? _d_clr_T_1[2063:0] : 2064'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_38 ? _d_sizes_clr_T_11[8255:0] : 8256'h0);
