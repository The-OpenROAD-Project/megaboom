...
module TLMonitor_21(
  ...
  `ifndef SYNTHESIS
    ...
    wire [1031:0] _GEN_30 = {1021'h0, io_in_d_bits_source, 3'h0};
    ...
    wire [128:0]  _GEN_33 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0]  _GEN_38 = inflight >> io_in_a_bits_source;
    wire [128:0]  _GEN_39 = inflight >> _GEN_33;
    wire [1031:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_30;
    wire [255:0]  _d_clr_wo_ready_T = 256'h1 << _GEN_2;
    wire [128:0]  _GEN_40 = inflight_1 >> _GEN_33;
    wire [1031:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_30;
    always @(posedge clock) begin
      ...
      if (_GEN_35 & _GEN_36 != {1'h0, _a_size_lookup_T_1[7:1]}) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_32 ? _d_clr_wo_ready_T[128:0] : 129'h0) | a_set_wo_ready == 129'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_37 & _GEN_36 != {1'h0, _c_size_lookup_T_1[7:1]}) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:43:9)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire [2062:0] _GEN_42 = {2052'h0, io_in_d_bits_source, 3'h0};
  ...
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hFF << _GEN_42;
  ...
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hFF << _GEN_42;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_43 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_43 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[1031:0] : 1032'h0)) & ~(_GEN_43 ? _d_sizes_clr_T_5[1031:0] : 1032'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_44 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_44 ? _d_sizes_clr_T_11[1031:0] : 1032'h0);
    end
