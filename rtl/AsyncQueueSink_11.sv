...
module AsyncQueueSink_11(
  ...
  wire [78:0] _io_deq_bits_deq_bits_reg_io_q;
  ...
  ClockCrossingReg_w79 io_deq_bits_deq_bits_reg (
    .clock (clock),
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[78:76];
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[75:74];
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[73:71];
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[70:67];
  assign io_deq_bits_sink = _io_deq_bits_deq_bits_reg_io_q[66];
