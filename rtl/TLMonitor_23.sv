...
module TLMonitor_23(
  ...
  reg            denied;
  reg  [2063:0]  inflight;
  reg  [8255:0]  inflight_opcodes;
  reg  [8255:0]  inflight_sizes;
  reg            a_first_counter_1;
  reg            d_first_counter_1;
  wire [8255:0]  _GEN = {8242'h0, io_in_d_bits_source, 2'h0};
  wire [8255:0]  _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN;
  wire [4095:0]  _GEN_0 = {4084'h0, io_in_a_bits_source};
  wire           _GEN_1 = a_first_done & ~a_first_counter_1;
  wire           d_release_ack = io_in_d_bits_opcode == 3'h6;
  wire [4095:0]  _GEN_2 = {4084'h0, io_in_d_bits_source};
  reg  [2:0]     casez_tmp;
  always @(*) begin
  ...
  reg  [31:0]    watchdog;
  reg  [2063:0]  inflight_1;
  reg  [8255:0]  inflight_sizes_1;
  ...
  `ifndef SYNTHESIS
    ...
    wire          _GEN_5 = io_in_a_bits_source > 12'h80F;
    wire          _GEN_6 = io_in_a_bits_param > 3'h2;
    wire          _GEN_7 = io_in_a_bits_mask != 8'hFF;
    wire          _GEN_8 = io_in_a_valid & (&io_in_a_bits_opcode) & ~reset;
    wire          _GEN_9 = io_in_a_bits_source < 12'h810;
    ...
    wire          _GEN_20 = io_in_d_bits_source > 12'h80F;
    ...
    wire [4095:0] _a_set_wo_ready_T = 4096'h1 << _GEN_0;
    wire [2063:0] a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[2063:0] : 2064'h0;
    wire          _GEN_31 = io_in_d_valid & ~d_first_counter_1;
    wire          _GEN_32 = _GEN_31 & ~d_release_ack;
    wire          same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;
    wire [2063:0] _GEN_33 = {2052'h0, io_in_d_bits_source};
    ...
    wire [2063:0] _GEN_38 = inflight >> io_in_a_bits_source;
    wire [2063:0] _GEN_39 = inflight >> _GEN_33;
    wire [8255:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN;
    wire [4095:0] _d_clr_wo_ready_T = 4096'h1 << _GEN_2;
    wire [2063:0] _GEN_40 = inflight_1 >> _GEN_33;
    wire [8255:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN;
    always @(posedge clock) begin
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_32 ? _d_clr_wo_ready_T[2063:0] : 2064'h0) | a_set_wo_ready == 2064'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(inflight == 2064'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(inflight_1 == 2064'h0 | _plusarg_reader_1_out == 32'h0 | watchdog_1 < _plusarg_reader_1_out)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: TileLink timeout expired (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:142:60)\n    at Monitor.scala:42 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire [32782:0] _GEN_41 = {32769'h0, io_in_d_bits_source, 2'h0};
  wire [4095:0]  _d_clr_T = 4096'h1 << _GEN_2;
  wire [4095:0]  _a_set_T = 4096'h1 << _GEN_0;
  wire [32782:0] _d_opcodes_clr_T_5 = 32783'hF << _GEN_41;
  wire [32770:0] _a_opcodes_set_T_1 = {32767'h0, _GEN_1 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {32757'h0, io_in_a_bits_source, 2'h0};
  wire [32782:0] _d_sizes_clr_T_5 = 32783'hF << _GEN_41;
  wire [32769:0] _a_sizes_set_T_1 = {32767'h0, _GEN_1 ? {io_in_a_bits_size, 1'h1} : 3'h0} << {32756'h0, io_in_a_bits_source, 2'h0};
  wire [4095:0]  _d_clr_T_1 = 4096'h1 << _GEN_2;
  wire [32782:0] _d_sizes_clr_T_11 = 32783'hF << _GEN_41;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= 2064'h0;
      inflight_opcodes <= 8256'h0;
      inflight_sizes <= 8256'h0;
      a_first_counter_1 <= 1'h0;
      d_first_counter_1 <= 1'h0;
      watchdog <= 32'h0;
      inflight_1 <= 2064'h0;
      inflight_sizes_1 <= 8256'h0;
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[2063:0] : 2064'h0)) & ~(_GEN_42 ? _d_clr_T[2063:0] : 2064'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_42 ? _d_opcodes_clr_T_5[8255:0] : 8256'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_42 ? _d_sizes_clr_T_5[8255:0] : 8256'h0);
      ...
      inflight_1 <= inflight_1 & ~(_GEN_43 ? _d_clr_T_1[2063:0] : 2064'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_43 ? _d_sizes_clr_T_11[8255:0] : 8256'h0);
