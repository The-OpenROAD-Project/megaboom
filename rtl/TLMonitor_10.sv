...
module TLMonitor_10(
  ...
  reg  [515:0]  inflight_sizes;
  reg  [2:0]    a_first_counter_1;
  wire          a_first_1 = a_first_counter_1 == 3'h0;
  reg  [2:0]    d_first_counter_1;
  wire          d_first_1 = d_first_counter_1 == 3'h0;
  wire [515:0]  _GEN_0 = {506'h0, io_in_d_bits_source, 2'h0};
  wire [515:0]  _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_0;
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_7 = io_in_a_bits_size == 3'h6;
    ...
    wire         _GEN_11 = io_in_a_bits_source[7:4] == 4'h4;
    wire         _GEN_12 = io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset;
    wire         _GEN_13 = io_in_a_bits_size != 3'h7 & io_in_a_bits_address[12];
    ...
    wire         _GEN_17 = ~(io_in_a_bits_size[2]) & io_in_a_bits_address[12];
    ...
    wire [255:0] _a_set_wo_ready_T = 256'h1 << _GEN_1;
    ...
    wire [128:0] _GEN_34 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0] _GEN_39 = inflight >> _GEN_34;
    wire [515:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_0;
    wire [255:0] _d_clr_wo_ready_T = 256'h1 << _GEN_3;
    wire [128:0] _GEN_40 = inflight_1 >> _GEN_34;
    wire [515:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_0;
    always @(posedge clock) begin
      ...
      if (_GEN_5 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & io_in_a_bits_address[12])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_10 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & io_in_a_bits_address[12])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_12 & ~(_GEN_11 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_15 & ~((_GEN_11 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_13)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_16 & ~((_GEN_11 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_13)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_18 & ~((_GEN_11 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_17)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_19 & ~((_GEN_11 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_17)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_33 ? _d_clr_wo_ready_T[128:0] : 129'h0) | a_set_wo_ready == 129'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [2050:0] _GEN_42 = {2041'h0, io_in_a_bits_source, 2'h0};
  wire [2062:0] _GEN_43 = {2053'h0, io_in_d_bits_source, 2'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_3;
  wire [255:0]  _a_set_T = 256'h1 << _GEN_1;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << _GEN_43;
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_2 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_42;
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hF << _GEN_43;
  wire [2050:0] _a_sizes_set_T_1 = {2047'h0, _GEN_2 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_42;
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_3;
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hF << _GEN_43;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_sizes <= 516'h0;
      a_first_counter_1 <= 3'h0;
      d_first_counter_1 <= 3'h0;
      watchdog <= 32'h0;
      inflight_1 <= 129'h0;
      inflight_sizes_1 <= 516'h0;
      ...
      inflight <= (inflight | (_GEN_2 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_44 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_2 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_44 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_2 ? _a_sizes_set_T_1[515:0] : 516'h0)) & ~(_GEN_44 ? _d_sizes_clr_T_5[515:0] : 516'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_45 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_45 ? _d_sizes_clr_T_11[515:0] : 516'h0);
    end
