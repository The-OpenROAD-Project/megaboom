...
module TLMonitor_8(
  ...
  `ifndef SYNTHESIS
    ...
    wire [128:0] _GEN_37 = inflight >> io_in_a_bits_source;
    wire [128:0] _GEN_38 = inflight >> _GEN_33;
    wire [515:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_0;
    wire [255:0] _d_clr_wo_ready_T = 256'h1 << _GEN_3;
    wire [128:0] _GEN_39 = inflight_1 >> _GEN_33;
  ...
  wire [2050:0] _GEN_41 = {2041'h0, io_in_a_bits_source, 2'h0};
  wire [2062:0] _GEN_42 = {2053'h0, io_in_d_bits_source, 2'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_3;
  wire [255:0]  _a_set_T = 256'h1 << _GEN_1;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << _GEN_42;
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_2 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_41;
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hF << _GEN_42;
  wire [2050:0] _a_sizes_set_T_1 = {2047'h0, _GEN_2 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_41;
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_3;
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hF << _GEN_42;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_2 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_43 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_2 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_43 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_2 ? _a_sizes_set_T_1[515:0] : 516'h0)) & ~(_GEN_43 ? _d_sizes_clr_T_5[515:0] : 516'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_44 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_44 ? _d_sizes_clr_T_11[515:0] : 516'h0);
    end
