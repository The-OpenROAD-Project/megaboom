...
module InclusiveCacheBankScheduler(
  ...
  wire [1:0]  _mshrs_6_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_6_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_6_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [1:0]  _mshrs_5_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_5_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_5_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [1:0]  _mshrs_4_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_4_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_4_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [1:0]  _mshrs_3_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_3_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_3_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [1:0]  _mshrs_2_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_2_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_2_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [1:0]  _mshrs_1_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_1_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_1_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [1:0]  _mshrs_0_io_schedule_bits_b_bits_clients;
  ...
  wire [6:0]  _mshrs_0_io_schedule_bits_d_bits_source;
  ...
  wire [1:0]  _mshrs_0_io_schedule_bits_dir_bits_data_clients;
  ...
  wire [6:0]  _requests_io_data_source;
  ...
  wire [1:0]  _directory_io_result_bits_clients;
  ...
  wire [6:0]  _sinkC_io_req_bits_source;
  ...
  wire [6:0]  _sinkC_io_resp_bits_source;
  ...
  wire [6:0]  _sinkA_io_req_bits_source;
  ...
  wire [6:0]  _view__WIRE_6_source = _sinkC_io_req_valid ? _sinkC_io_req_bits_source : _sinkX_io_req_valid ? 7'h0 : _sinkA_io_req_bits_source;
  ...
  Directory directory (
    ...
    .io_write_bits_data_clients ((mshr_selectOH[0] ? _mshrs_0_io_schedule_bits_dir_bits_data_clients : 2'h0) | (mshr_selectOH[1] ? _mshrs_1_io_schedule_bits_dir_bits_data_clients : 2'h0) | (mshr_selectOH[2] ? _mshrs_2_io_schedule_bits_dir_bits_data_clients : 2'h0) | (mshr_selectOH[3] ? _mshrs_3_io_schedule_bits_dir_bits_data_clients : 2'h0) | (mshr_selectOH[4] ? _mshrs_4_io_schedule_bits_dir_bits_data_clients : 2'h0) | (mshr_selectOH[5] ? _mshrs_5_io_schedule_bits_dir_bits_data_clients : 2'h0) | (mshr_selectOH[6] ? _mshrs_6_io_schedule_bits_dir_bits_data_clients : 2'h0)),
