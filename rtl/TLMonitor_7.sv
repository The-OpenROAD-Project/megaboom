...
module TLMonitor_7(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_9 = io_in_a_bits_source[7:4] == 4'h4;
    wire         _GEN_10 = io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset;
    wire         _GEN_11 = io_in_a_bits_size != 3'h7 & io_in_a_bits_address[12];
    ...
    wire [128:0] _GEN_26 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0] _GEN_30 = inflight >> io_in_a_bits_source;
    wire [128:0] _GEN_31 = inflight >> _GEN_26;
    wire [515:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_0;
    wire [128:0] _GEN_32 = inflight_1 >> _GEN_26;
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_3 & ~((_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5) & io_in_a_bits_address[12])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_8 & ~((_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5) & io_in_a_bits_address[12])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_10 & ~(_GEN_9 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_13 & ~((_GEN_9 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_11)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_14 & ~((_GEN_9 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_11)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [2050:0] _GEN_34 = {2041'h0, io_in_a_bits_source, 2'h0};
  wire [255:0]  _GEN_35 = {248'h0, io_in_d_bits_source};
  wire [2062:0] _GEN_36 = {2053'h0, io_in_d_bits_source, 2'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_35;
  wire [255:0]  _a_set_T = 256'h1 << io_in_a_bits_source;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << _GEN_36;
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_1 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_34;
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hF << _GEN_36;
  wire [2050:0] _a_sizes_set_T_1 = {2047'h0, _GEN_1 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_34;
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_35;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_37 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_37 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[515:0] : 516'h0)) & ~(_GEN_37 ? _d_sizes_clr_T_5[515:0] : 516'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_38 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_38 ? _d_sizes_clr_T_11[515:0] : 516'h0);
    end
