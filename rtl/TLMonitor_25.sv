...
module TLMonitor_25(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_13 = io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26]));
    ...
    wire [128:0] _GEN_28 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0] _GEN_32 = inflight >> io_in_a_bits_source;
    wire [128:0] _GEN_33 = inflight >> _GEN_28;
    wire [515:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_0;
    wire [255:0] _d_clr_wo_ready_T = 256'h1 << _GEN_3;
    wire [128:0] _GEN_34 = inflight_1 >> _GEN_28;
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_5 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & (&(io_in_a_bits_address[27:26])))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_10 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & (&(io_in_a_bits_address[27:26])))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_2 & ~reset & _GEN_32[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_30 & io_in_d_bits_size != _a_size_lookup_T_1[3:1]) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:364:63)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_26 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & ~(a_set_wo_ready != (_GEN_27 ? _d_clr_wo_ready_T[128:0] : 129'h0) | a_set_wo_ready == 129'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_31 & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:364:63)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire [2050:0] _GEN_36 = {2041'h0, io_in_a_bits_source, 2'h0};
  wire [2062:0] _GEN_37 = {2053'h0, io_in_d_bits_source, 2'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_3;
  wire [255:0]  _a_set_T = 256'h1 << _GEN_1;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << _GEN_37;
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_2 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_36;
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hF << _GEN_37;
  wire [2050:0] _a_sizes_set_T_1 = {2047'h0, _GEN_2 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_36;
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_3;
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hF << _GEN_37;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_2 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_38 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_2 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_38 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_2 ? _a_sizes_set_T_1[515:0] : 516'h0)) & ~(_GEN_38 ? _d_sizes_clr_T_5[515:0] : 516'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_39 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_39 ? _d_sizes_clr_T_11[515:0] : 516'h0);
    end
