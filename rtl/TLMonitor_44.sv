...
module TLMonitor_44(
  ...
  `ifndef SYNTHESIS
    ...
    wire        _GEN_29 = _GEN_22 | _GEN_23;
    wire        _GEN_30 = _GEN_13 & _GEN_15 & _GEN_12 & (_GEN_29 | _GEN_24 | _GEN_25 | _GEN_26 | _GEN_27 | _GEN_16 | _GEN_28 | _GEN_17 | _GEN_18);
    wire        _GEN_31 = io_in_a_bits_param > 3'h2;
    wire        _GEN_32 = io_in_a_bits_mask != 16'hFFFF;
    wire        _GEN_33 = io_in_a_valid & (&io_in_a_bits_opcode) & ~reset;
    wire        _GEN_34 = io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset;
    wire        _GEN_35 = _GEN_12 & _GEN_23;
    wire        _GEN_36 = io_in_a_bits_size < 4'h7;
    wire        _GEN_37 = io_in_a_bits_mask != mask;
    wire        _GEN_38 = _GEN_14 & (_GEN_35 | _GEN_36 & (_GEN_22 | _GEN_25 | _GEN_26 | _GEN_27 | _GEN_16 | _GEN_28 | _GEN_17 | _GEN_18));
    wire        _GEN_39 = io_in_a_valid & io_in_a_bits_opcode == 3'h0 & ~reset;
    wire        _GEN_40 = io_in_a_valid & io_in_a_bits_opcode == 3'h1 & ~reset;
    wire        _GEN_41 = _GEN_14 & io_in_a_bits_size < 4'h4 & (_GEN_29 | _GEN_25 | _GEN_26 | _GEN_27 | _GEN_16 | _GEN_28 | _GEN_17 | _GEN_18);
    ...
    wire        _GEN_46 = io_in_d_bits_size[3:2] == 2'h0;
    ...
    wire        address_ok = ~(|_GEN_54) | ~(|_GEN_55) | {io_in_b_bits_address[32:13], ~(io_in_b_bits_address[12])} == 21'h0 | ~(|_GEN_56) | ~(|_GEN_57) | io_in_b_bits_address[32:12] == 21'h0 | ~(|_GEN_58) | {io_in_b_bits_address[32:21], _GEN_59} == 21'h0 | {io_in_b_bits_address[32:21], io_in_b_bits_address[20:12] ^ 9'h110} == 21'h0 | ~(|_GEN_60) | ~_GEN_61 | ~(|_GEN_62);
    ...
    wire        _GEN_65 = (io_in_b_bits_source == 4'h9 ? 4'h9 : 4'h0) != io_in_b_bits_source;
    ...
    wire [6:0]  _GEN_76 = {io_in_c_bits_address[32:28], ~(io_in_c_bits_address[27:26])};
    wire [16:0] _GEN_77 = {io_in_c_bits_address[32:26], io_in_c_bits_address[25:16] ^ 10'h200};
    wire [16:0] _GEN_78 = {io_in_c_bits_address[32:17], ~(io_in_c_bits_address[16])};
    wire [8:0]  _GEN_79 = io_in_c_bits_address[20:12] ^ 9'h100;
    wire [1:0]  _GEN_80 = {io_in_c_bits_address[32], ~(io_in_c_bits_address[31])};
    wire        _GEN_81 = io_in_c_bits_address[32:31] != 2'h2;
    wire [16:0] _GEN_82 = {io_in_c_bits_address[32:28], io_in_c_bits_address[27:16] ^ 12'h800};
    wire        address_ok_1 = ~(|_GEN_74) | ~(|_GEN_75) | {io_in_c_bits_address[32:13], ~(io_in_c_bits_address[12])} == 21'h0 | ~(|_GEN_76) | ~(|_GEN_77) | io_in_c_bits_address[32:12] == 21'h0 | ~(|_GEN_78) | {io_in_c_bits_address[32:21], _GEN_79} == 21'h0 | {io_in_c_bits_address[32:21], io_in_c_bits_address[20:12] ^ 9'h110} == 21'h0 | ~(|_GEN_80) | ~_GEN_81 | ~(|_GEN_82);
    wire        _GEN_83 = io_in_c_valid & io_in_c_bits_opcode == 3'h4 & ~reset;
    wire        _GEN_84 = io_in_c_bits_size[3:2] == 2'h0;
    wire        _GEN_85 = io_in_c_valid & io_in_c_bits_opcode == 3'h5 & ~reset;
    wire        _GEN_86 = io_in_c_bits_size < 4'hD;
    wire        _GEN_87 = io_in_c_bits_source < 4'h9;
    wire        _GEN_88 = io_in_c_bits_size == 4'h6;
    wire        _GEN_89 = _GEN_86 & (_GEN_87 | _source_ok_WIRE_2_1) & _GEN_88 & (~(|_GEN_82) | ~(|_GEN_80) | ~_GEN_81);
    wire        _GEN_90 = io_in_c_valid & io_in_c_bits_opcode == 3'h6 & ~reset;
    wire        _GEN_91 = _GEN_87 & _GEN_88 & _GEN_86 & (io_in_c_bits_address[32:13] == 20'h0 | ~(|_GEN_74) | ~(|_GEN_78) | {io_in_c_bits_address[32:21], _GEN_79[8:5], io_in_c_bits_address[15:12]} == 20'h0 | ~(|_GEN_77) | ~(|_GEN_75) | ~(|_GEN_82) | ~(|_GEN_76) | ~(|_GEN_80) | ~_GEN_81);
    ...
    wire [79:0] _GEN_100 = {73'h0, io_in_d_bits_source, 3'h0};
    ...
    wire [9:0]  _GEN_103 = {6'h0, io_in_d_bits_source};
    ...
    wire [9:0]  _GEN_109 = inflight >> io_in_a_bits_source;
    wire [9:0]  _GEN_110 = inflight >> _GEN_103;
    wire [79:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_100;
    wire [15:0] _d_clr_wo_ready_T = 16'h1 << _GEN_3;
    wire [9:0]  _GEN_111 = inflight_1 >> io_in_c_bits_source;
    wire [9:0]  _GEN_112 = inflight_1 >> _GEN_103;
    wire [79:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_100;
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_33 & ~(|(io_in_a_bits_size[3:2]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_34 & ~(_GEN_35 | _GEN_36 & (_GEN_22 | _GEN_24 | _GEN_25 | _GEN_26 | _GEN_27 | _GEN_16 | _GEN_28 | _GEN_17 | _GEN_18))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_44 & ~(_GEN_14 & (_GEN_35 | _GEN_36 & _GEN_19))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_64 & ~(io_in_b_bits_source < 4'h9 & io_in_b_bits_size == 4'h6 & io_in_b_bits_size < 4'hD & (io_in_b_bits_address[32:13] == 20'h0 | ~(|_GEN_54) | ~(|_GEN_58) | {io_in_b_bits_address[32:21], _GEN_59[8:5], io_in_b_bits_address[15:12]} == 20'h0 | ~(|_GEN_57) | ~(|_GEN_55) | ~(|_GEN_62) | ~(|_GEN_56) | ~(|_GEN_60) | ~_GEN_61))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_102 ? _d_clr_wo_ready_T[9:0] : 10'h0) | a_set_wo_ready == 10'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 5 (connected at generators/boom/src/main/scala/common/tile.scala:132:84)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      ...
      if ((|c_set_wo_ready) & ~reset & c_set_wo_ready == (_GEN_108 ? _d_clr_wo_ready_T_1[9:0] : 10'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'C' and 'D' concurrent, despite minlatency 5 (connected at generators/boom/src/main/scala/common/tile.scala:132:84)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
  ...
  wire [142:0] _GEN_117 = {136'h0, io_in_d_bits_source, 3'h0};
  ...
  wire [142:0] _d_sizes_clr_T_5 = 143'hFF << _GEN_117;
  ...
  wire [142:0] _d_sizes_clr_T_11 = 143'hFF << _GEN_117;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_2 ? _a_set_T[9:0] : 10'h0)) & ~(_GEN_116 ? _d_clr_T[9:0] : 10'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_2 ? _a_opcodes_set_T_1[39:0] : 40'h0)) & ~(_GEN_116 ? _d_opcodes_clr_T_5[39:0] : 40'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_2 ? _a_sizes_set_T_1[79:0] : 80'h0)) & ~(_GEN_116 ? _d_sizes_clr_T_5[79:0] : 80'h0);
      if (_a_first_T_1 | _d_first_T_3)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= (inflight_1 | (_GEN_6 ? _c_set_T[9:0] : 10'h0)) & ~(_GEN_118 ? _d_clr_T_1[9:0] : 10'h0);
      inflight_sizes_1 <= (inflight_sizes_1 | (_GEN_6 ? _c_sizes_set_T_1[79:0] : 80'h0)) & ~(_GEN_118 ? _d_sizes_clr_T_11[79:0] : 80'h0);
