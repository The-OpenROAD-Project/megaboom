...
module TLMonitor_15(
  ...
  `ifndef SYNTHESIS
    ...
    wire          _GEN_4 = io_in_a_bits_source[7:4] == 4'h2;
    wire          _GEN_5 = io_in_a_bits_size == 4'h6;
    wire          _GEN_6 = io_in_a_bits_address[27:13] == 15'h0;
    ...
    wire          _GEN_9 = {io_in_a_bits_address[27:21], io_in_a_bits_address[20:17] ^ 4'h8, io_in_a_bits_address[15:12]} == 15'h0;
    wire          _GEN_10 = {io_in_a_bits_address[27:26], io_in_a_bits_address[25:16] ^ 10'h200} == 12'h0;
    wire          _GEN_11 = {io_in_a_bits_address[27:26], io_in_a_bits_address[25:12] ^ 14'h2010} == 16'h0;
    wire          _GEN_12 = _GEN_2 & (_GEN_6 | _GEN_7 | _GEN_8 | _GEN_9 | _GEN_10 | _GEN_11 | (&(io_in_a_bits_address[27:26])));
    ...
    wire          _GEN_16 = io_in_a_bits_source[7:4] == 4'h4;
    wire          _GEN_17 = io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset;
    wire          _GEN_18 = _GEN_2 & _GEN_7;
    wire          _GEN_19 = io_in_a_bits_size < 4'h7;
    wire          _GEN_20 = io_in_a_bits_mask != mask;
    wire          _GEN_21 = _GEN_18 | _GEN_19 & (_GEN_6 | _GEN_9 | _GEN_10 | _GEN_11 | (&(io_in_a_bits_address[27:26])));
    ...
    wire [1031:0] _GEN_39 = {1021'h0, io_in_d_bits_source, 3'h0};
    wire          _GEN_40 = io_in_d_valid & d_first_1;
    wire          _GEN_41 = _GEN_40 & ~d_release_ack;
    wire          same_cycle_resp = io_in_a_valid & a_first_1 & io_in_a_bits_source == io_in_d_bits_source;
    wire [128:0]  _GEN_42 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0]  _GEN_47 = inflight >> io_in_a_bits_source;
    wire [128:0]  _GEN_48 = inflight >> _GEN_42;
    wire [1031:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_39;
    wire [128:0]  _GEN_49 = inflight_1 >> _GEN_42;
    wire [1031:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_39;
    always @(posedge clock) begin
      ...
      if (_GEN_3 & ~((_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5) & _GEN_12)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_15 & ~((_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5) & _GEN_12)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_17 & ~(_GEN_2 & (_GEN_16 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_17 & ~(_GEN_18 | _GEN_19 & (_GEN_6 | _GEN_8 | _GEN_9 | _GEN_10 | _GEN_11 | (&(io_in_a_bits_address[27:26]))))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_22 & ~(_GEN_2 & (_GEN_16 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_21)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_23 & ~(_GEN_2 & (_GEN_16 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_21)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_25 & ~(_GEN_2 & (_GEN_16 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_24)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_26 & ~(_GEN_2 & (_GEN_16 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_24)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_27 & ~(_GEN_2 & (_GEN_16 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_18)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_0 & ~reset & _GEN_47[0]) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [255:0]  _GEN_51 = {248'h0, io_in_d_bits_source};
  wire [2062:0] _GEN_52 = {2052'h0, io_in_d_bits_source, 3'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_51;
  wire [255:0]  _a_set_T = 256'h1 << io_in_a_bits_source;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << {2053'h0, io_in_d_bits_source, 2'h0};
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_0 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {2041'h0, io_in_a_bits_source, 2'h0};
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hFF << _GEN_52;
  wire [2051:0] _a_sizes_set_T_1 = {2047'h0, _GEN_0 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {2041'h0, io_in_a_bits_source, 3'h0};
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_51;
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hFF << _GEN_52;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_0 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_53 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_0 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_53 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_0 ? _a_sizes_set_T_1[1031:0] : 1032'h0)) & ~(_GEN_53 ? _d_sizes_clr_T_5[1031:0] : 1032'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_54 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_54 ? _d_sizes_clr_T_11[1031:0] : 1032'h0);
    end
