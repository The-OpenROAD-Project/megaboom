...
module AsyncQueueSink_4(
  ...
  always @(*) begin
    casez (_index_T ^ {ridx_incremented[3], 2'h0})
      3'b000:
        casez_tmp = io_async_mem_0_sink;
      3'b001:
        casez_tmp = io_async_mem_1_sink;
      3'b010:
        casez_tmp = io_async_mem_2_sink;
      3'b011:
        casez_tmp = io_async_mem_3_sink;
      3'b100:
        casez_tmp = io_async_mem_4_sink;
      3'b101:
        casez_tmp = io_async_mem_5_sink;
      3'b110:
        casez_tmp = io_async_mem_6_sink;
      default:
        casez_tmp = io_async_mem_7_sink;
    endcase
  end // always @(*)
  reg        valid_reg;
  ...
  ClockCrossingReg_w3 io_deq_bits_deq_bits_reg (
    .clock (clock),
    .io_d  (casez_tmp),
