...
module AsyncQueueSink_18(
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_128 widx_widx_gray (
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
  ...
  ClockCrossingReg_w17 io_deq_bits_deq_bits_reg (
    .clock (clock),
    .io_d  ({io_async_mem_0_resumereq, io_async_mem_0_hartsel, io_async_mem_0_ackhavereset, io_async_mem_0_hasel, io_async_mem_0_hamask_1, io_async_mem_0_hamask_0, io_async_mem_0_hrmask_1, io_async_mem_0_hrmask_0}),
