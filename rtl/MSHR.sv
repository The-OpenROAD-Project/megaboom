...
module MSHR(
  ...
  output [1:0]  io_schedule_bits_b_bits_clients,
  ...
  wire [1:0]  req_clientBit = {request_source[6:4] == 3'h0 & request_source[3:0] < 4'h9, request_source[6:4] == 3'h2 & request_source[3:0] < 4'h9};
  ...
  wire [1:0]  _final_meta_writeback_clients_T_7 = meta_clients & ~(request_param == 3'h1 | request_param == 3'h2 | request_param == 3'h5 ? req_clientBit : 2'h0);
  wire [1:0]  _GEN = ({2{~meta_hit}} | ~probes_toN) & meta_clients;
  ...
  wire [1:0]  _final_meta_writeback_clients_T_14 = (meta_hit ? meta_clients & ~probes_toN : 2'h0) | (req_acquire ? req_clientBit : 2'h0);
  wire        _GEN_0 = request_prio_2 | request_control;
  wire        _GEN_1 = request_prio_2 | ~request_control;
  wire [1:0]  _final_meta_writeback_clients_T_16 = meta_clients & ~probes_toN;
  ...
  wire [1:0]  _io_schedule_bits_dir_bits_data_WIRE_clients = bad_grant ? (meta_hit ? _final_meta_writeback_clients_T_16 : 2'h0) : request_prio_2 ? _final_meta_writeback_clients_T_7 : request_control ? _GEN : _final_meta_writeback_clients_T_14;
  wire [1:0]  excluded_client = meta_hit & request_prio_0 & (_excluded_client_T_1 | (&request_opcode) | request_opcode == 3'h4) ? req_clientBit : 2'h0;
  wire [3:0]  _GEN_3 = {2'h1, ~(|meta_clients), ~meta_dirty};
  wire [3:0]  _GEN_4 = {3'h1, ~meta_dirty};
  reg  [3:0]  casez_tmp;
  always @(*) begin
    casez (meta_state)
      2'b00:
  ...
  wire [3:0]  _GEN_5 = {2'h1, ~(|_io_schedule_bits_dir_bits_data_WIRE_clients), ~_io_schedule_bits_dir_bits_data_WIRE_dirty};
  wire [3:0]  _GEN_6 = {3'h1, ~_io_schedule_bits_dir_bits_data_WIRE_dirty};
  reg  [3:0]  casez_tmp_1;
  always @(*) begin
  ...
  wire        _GEN_7 = io_directory_valid | _new_meta_T;
  `ifndef SYNTHESIS
    wire       _GEN_8 = meta_valid & ~(|meta_state) & ~reset;
    wire       _GEN_9 = meta_state == 2'h1;
    wire       _GEN_10 = meta_valid & meta_state == 2'h2 & ~reset;
    wire [3:0] evict = meta_hit ? 4'h8 : casez_tmp;
    wire [3:0] before_0 = meta_hit ? casez_tmp_0 : 4'h8;
    wire       _GEN_11 = ~s_release & w_rprobeackfirst & io_schedule_ready & ~reset;
    wire       _GEN_12 = before_0 == 4'h1;
    wire       _GEN_13 = before_0 == 4'h0;
    wire       _GEN_14 = before_0 == 4'h8;
    wire       _GEN_15 = casez_tmp_1 == 4'h1;
    wire       _GEN_16 = ~s_writeback & no_wait & io_schedule_ready & ~reset;
    wire       _GEN_17 = casez_tmp_1 == 4'h0;
    wire       _GEN_18 = casez_tmp_1 == 4'h7;
    wire       _GEN_19 = casez_tmp_1 == 4'h5;
    wire       _GEN_20 = casez_tmp_1 == 4'h4;
    wire       _GEN_21 = casez_tmp_1 == 4'h6;
    wire       _GEN_22 = casez_tmp_1 == 4'h3;
    wire       _GEN_23 = casez_tmp_1 == 4'h2;
    wire       _GEN_24 = casez_tmp_1 == 4'h8;
    wire       _GEN_25 = before_0 == 4'h7;
    wire       _GEN_26 = before_0 == 4'h5;
    wire       _GEN_27 = before_0 == 4'h6;
    wire       _GEN_28 = before_0 == 4'h4;
    wire       _GEN_29 = before_0 == 4'h3;
    wire       _GEN_30 = before_0 == 4'h2;
    wire       _GEN_31 = _new_meta_T & ~reset;
    always @(posedge clock) begin
      if (_GEN_8 & (|meta_clients)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at MSHR.scala:105 assert (!meta.clients.orR)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_8 & meta_dirty) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at MSHR.scala:106 assert (!meta.dirty)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (meta_valid & _GEN_9 & ~reset & meta_dirty) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at MSHR.scala:109 assert (!meta.dirty)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_10 & ~(|meta_clients)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at MSHR.scala:112 assert (meta.clients.orR)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_10 & (|(meta_clients & meta_clients - 2'h1))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (bad_grant & meta_hit & ~reset & ~(~meta_valid | _GEN_9)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed\n    at MSHR.scala:254 assert (!meta_valid || meta.state === BRANCH)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_11 & evict == 4'h1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_16 & _GEN_14 & _GEN_15) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_31 & casez_tmp_2 == 4'h0) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_7 & new_request_prio_2 & ~reset & ~new_meta_hit) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [1:0]  new_meta_clients = _new_meta_T ? _io_schedule_bits_dir_bits_data_WIRE_clients : io_directory_bits_clients;
  ...
  wire [6:0]  new_request_source = io_allocate_valid ? io_allocate_bits_source : request_source;
  ...
  wire [1:0]  new_clientBit = {new_request_source[6:4] == 3'h0 & new_request_source[3:0] < 4'h9, new_request_source[6:4] == 3'h2 & new_request_source[3:0] < 4'h9};
  wire        _GEN_32 = new_meta_state == 2'h2;
  wire        _GEN_33 = new_meta_clients == 2'h0;
  wire        _GEN_34 = ~new_meta_hit & (|new_meta_state);
  wire        _GEN_35 = new_request_prio_2 | (new_request_control ? ~new_meta_hit : ~_GEN_34);
  wire        _GEN_36 = new_request_prio_2 | (new_request_control ? ~new_meta_hit | _GEN_33 : ~_GEN_34 | _GEN_33);
  ...
  wire        _GEN_40 = new_meta_hit & (new_needT | _GEN_32) & (|(new_meta_clients & ~(_new_skipProbe_T | (&new_request_opcode) | new_request_opcode == 3'h4 ? new_clientBit : 2'h0)));
  ...
  wire [1:0]  _GEN_45 = {2{io_sinkc_valid}};
  wire [1:0]  probe_bit = {io_sinkc_bits_source[6:4] == 3'h0 & io_sinkc_bits_source[3:0] < 4'h9, io_sinkc_bits_source[6:4] == 3'h2 & io_sinkc_bits_source[3:0] < 4'h9};
  wire        _GEN_46 = io_sinkd_bits_opcode == 3'h4 | io_sinkd_bits_opcode == 3'h5;
  wire        _GEN_47 = io_sinkd_valid & _GEN_46;
  wire        last_probe = (probes_done | probe_bit) == (meta_clients & ~excluded_client);
  wire        _GEN_48 = io_sinkc_valid & last_probe;
  wire        _GEN_49 = io_sinkc_valid & last_probe & io_sinkc_bits_last;
  always @(posedge clock) begin
    if (reset) begin
      request_valid <= 1'h0;
      meta_valid <= 1'h0;
      ...
      meta_valid <= _GEN_7 | ~_GEN_43 & meta_valid;
      if (_GEN_7) begin
        s_rprobe <= _GEN_36;
        ...
        s_writeback <= new_request_prio_2 ? ~((new_request_param == 3'h1 | new_request_param == 3'h2 | new_request_param == 3'h5) & (|(new_meta_clients & new_clientBit)) | (new_request_param == 3'h0 | new_request_param == 3'h4) & _GEN_32) & ~(new_request_opcode[0] & ~new_meta_dirty) : new_request_control | ~(~(new_request_opcode[2]) & new_meta_hit & ~new_meta_dirty | _GEN_42 | _GEN_40) & ~_GEN_37;
      end
      else begin
        s_rprobe <= io_schedule_ready | s_rprobe;
        w_rprobeackfirst <= _GEN_48 | w_rprobeackfirst;
        w_rprobeacklast <= _GEN_49 | w_rprobeacklast;
        s_release <= io_schedule_ready & w_rprobeackfirst | s_release;
        w_releaseack <= io_sinkd_valid & ~_GEN_46 & io_sinkd_bits_opcode == 3'h6 | w_releaseack;
        ...
        w_grantfirst <= _GEN_47 | w_grantfirst;
        if (_GEN_47) begin
          w_grantlast <= io_sinkd_bits_last;
          w_grant <= ~(|request_offset) | io_sinkd_bits_last;
        end
        w_pprobeackfirst <= _GEN_48 | w_pprobeackfirst;
        w_pprobeacklast <= _GEN_49 | w_pprobeacklast;
    ...
    if (_GEN_7) begin
      if (_new_meta_T) begin
        ...
        if (bad_grant) begin
          meta_state <= _GEN_2;
          if (meta_hit)
            meta_clients <= _final_meta_writeback_clients_T_16;
          else
            meta_clients <= 2'h0;
        end
        else begin
      ...
      probes_done <= _GEN_45 & probe_bit | probes_done;
      probes_toN <= _GEN_45 & (io_sinkc_bits_param == 3'h1 | io_sinkc_bits_param == 3'h2 | io_sinkc_bits_param == 3'h5 ? probe_bit : 2'h0) | probes_toN;
    end
    if (~_GEN_7 | _new_meta_T) begin
    end
    else
      meta_way <= io_directory_bits_way;
    if (_GEN_47)
      sink <= io_sinkd_bits_sink;
    gotT <= ~_GEN_7 & (_GEN_47 ? io_sinkd_bits_param == 3'h0 : gotT);
    bad_grant <= ~_GEN_7 & (_GEN_47 ? io_sinkd_bits_denied : bad_grant);
  end // always @(posedge)
  ...
  assign io_schedule_bits_dir_bits_data_clients = s_release ? _io_schedule_bits_dir_bits_data_WIRE_clients : 2'h0;
