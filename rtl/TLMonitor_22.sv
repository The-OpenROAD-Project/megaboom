...
module TLMonitor_22(
  ...
  `ifndef SYNTHESIS
    ...
    wire          _GEN_8 = _GEN_4 & (&(io_in_a_bits_address[13:12]));
    ...
    wire          _GEN_12 = io_in_a_bits_source[7:4] == 4'h4;
    ...
    wire [1031:0] _GEN_32 = {1021'h0, io_in_d_bits_source, 3'h0};
    ...
    wire [128:0]  _GEN_35 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0]  _GEN_40 = inflight >> io_in_a_bits_source;
    wire [128:0]  _GEN_41 = inflight >> _GEN_35;
    wire [1031:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_32;
    wire [255:0]  _d_clr_wo_ready_T = 256'h1 << _GEN_2;
    wire [128:0]  _GEN_42 = inflight_1 >> _GEN_35;
    wire [1031:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_32;
    always @(posedge clock) begin
      ...
      if (_GEN_5 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & _GEN_8)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_11 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & _GEN_8)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_13 & ~(_GEN_4 & (_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_15 & ~(_GEN_4 & (_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_8)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_16 & ~(_GEN_4 & (_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_8)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_18 & ~(_GEN_4 & (_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_17)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_19 & ~(_GEN_4 & (_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_17)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_20 & ~(_GEN_4 & (_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_8)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_1 & ~reset & _GEN_40[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_34 & ~reset & ~(_GEN_41[0] | same_cycle_resp)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_36 & ~(io_in_d_bits_opcode == casez_tmp | io_in_d_bits_opcode == casez_tmp_0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_36 & io_in_a_bits_size != io_in_d_bits_size) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_37 & ~(io_in_d_bits_opcode == casez_tmp_1 | io_in_d_bits_opcode == casez_tmp_2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_37 & _GEN_38 != {1'h0, _a_size_lookup_T_1[7:1]}) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_33 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & ~(a_set_wo_ready != (_GEN_34 ? _d_clr_wo_ready_T[128:0] : 129'h0) | a_set_wo_ready == 129'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_39 & ~(_GEN_42[0])) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_39 & _GEN_38 != {1'h0, _c_size_lookup_T_1[7:1]}) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/CanHaveBuiltInDevices.scala:44:9)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire [2062:0] _GEN_44 = {2052'h0, io_in_d_bits_source, 3'h0};
  ...
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hFF << _GEN_44;
  ...
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hFF << _GEN_44;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_45 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_45 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[1031:0] : 1032'h0)) & ~(_GEN_45 ? _d_sizes_clr_T_5[1031:0] : 1032'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_46 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_46 ? _d_sizes_clr_T_11[1031:0] : 1032'h0);
    end
