...
module ClockSinkDomain_3(
  input         auto_reset_setter_clock_in_member_allClocks_bus_clock,
                auto_reset_setter_clock_in_member_allClocks_bus_reset,
                auto_reset_setter_clock_in_member_allClocks_uncore_clock,
                auto_reset_setter_clock_in_member_allClocks_uncore_reset,
  output        auto_resetSynchronizer_out_member_allClocks_bus_clock,
                auto_resetSynchronizer_out_member_allClocks_bus_reset,
  ...
  input  [7:0]  auto_xbar_in_a_bits_source,
  ...
  output [7:0]  auto_xbar_in_d_bits_source,
  ...
  wire [7:0]  _fragmenter_1_auto_in_d_bits_source;
  ...
  wire [11:0] _fragmenter_1_auto_out_a_bits_source;
  ...
  wire        _reset_setter_auto_clock_out_member_allClocks_bus_clock;
  wire        _reset_setter_auto_clock_out_member_allClocks_bus_reset;
  ...
  wire [11:0] _reset_setter_auto_tl_in_d_bits_source;
  ...
  wire [7:0]  _fragmenter_auto_in_d_bits_source;
  ...
  wire [11:0] _fragmenter_auto_out_a_bits_source;
  ...
  wire [11:0] _clock_gater_auto_clock_gater_in_1_d_bits_source;
  wire [63:0] _clock_gater_auto_clock_gater_in_1_d_bits_data;
  wire        _clock_gater_auto_clock_gater_out_member_allClocks_bus_clock;
  wire        _clock_gater_auto_clock_gater_out_member_allClocks_bus_reset;
  ...
  wire [7:0]  _xbar_auto_out_1_a_bits_source;
  ...
  wire [7:0]  _xbar_auto_out_0_a_bits_source;
  ...
  ClockGroupResetSynchronizer resetSynchronizer (
    .auto_in_member_allClocks_bus_clock     (_clock_gater_auto_clock_gater_out_member_allClocks_bus_clock),
    .auto_in_member_allClocks_bus_reset     (_clock_gater_auto_clock_gater_out_member_allClocks_bus_reset),
    ...
    .auto_out_member_allClocks_bus_clock    (auto_resetSynchronizer_out_member_allClocks_bus_clock),
    .auto_out_member_allClocks_bus_reset    (auto_resetSynchronizer_out_member_allClocks_bus_reset),
  ...
  TileClockGater clock_gater (
    ...
    .auto_clock_gater_in_0_member_allClocks_bus_clock    (_reset_setter_auto_clock_out_member_allClocks_bus_clock),
    .auto_clock_gater_in_0_member_allClocks_bus_reset    (_reset_setter_auto_clock_out_member_allClocks_bus_reset),
    ...
    .auto_clock_gater_out_member_allClocks_bus_clock     (_clock_gater_auto_clock_gater_out_member_allClocks_bus_clock),
    .auto_clock_gater_out_member_allClocks_bus_reset     (_clock_gater_auto_clock_gater_out_member_allClocks_bus_reset),
  ...
  TileResetSetter reset_setter (
    .clock                                        (auto_clock_in_clock),
    .reset                                        (auto_clock_in_reset),
    .auto_clock_in_member_allClocks_bus_clock     (auto_reset_setter_clock_in_member_allClocks_bus_clock),
    .auto_clock_in_member_allClocks_bus_reset     (auto_reset_setter_clock_in_member_allClocks_bus_reset),
    ...
    .auto_clock_out_member_allClocks_bus_clock    (_reset_setter_auto_clock_out_member_allClocks_bus_clock),
    .auto_clock_out_member_allClocks_bus_reset    (_reset_setter_auto_clock_out_member_allClocks_bus_reset),
