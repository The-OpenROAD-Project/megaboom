...
module TLMonitor_29(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_5 = io_in_a_bits_size == 3'h6;
    wire         _GEN_6 = {io_in_a_bits_address[20:17] ^ 4'h8, io_in_a_bits_address[15:12]} == 8'h0;
    ...
    wire         _GEN_10 = io_in_a_bits_source[7:4] == 4'h4;
    wire         _GEN_11 = io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset;
    wire         _GEN_12 = io_in_a_bits_size != 3'h7 & _GEN_6;
    ...
    wire [128:0] _GEN_27 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0] _GEN_31 = inflight >> io_in_a_bits_source;
    wire [128:0] _GEN_32 = inflight >> _GEN_27;
    wire [515:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_0;
    wire [128:0] _GEN_33 = inflight_1 >> _GEN_27;
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_3 & ~((_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5) & _GEN_6)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_9 & ~((_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5) & _GEN_6)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_11 & ~(_GEN_10 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_14 & ~((_GEN_10 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_12)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_15 & ~((_GEN_10 | _GEN_4 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_12)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [2050:0] _GEN_35 = {2041'h0, io_in_a_bits_source, 2'h0};
  wire [255:0]  _GEN_36 = {248'h0, io_in_d_bits_source};
  wire [2062:0] _GEN_37 = {2053'h0, io_in_d_bits_source, 2'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_36;
  wire [255:0]  _a_set_T = 256'h1 << io_in_a_bits_source;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << _GEN_37;
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_1 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_35;
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hF << _GEN_37;
  wire [2050:0] _a_sizes_set_T_1 = {2047'h0, _GEN_1 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_35;
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_36;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_38 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_38 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[515:0] : 516'h0)) & ~(_GEN_38 ? _d_sizes_clr_T_5[515:0] : 516'h0);
