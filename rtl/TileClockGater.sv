...
module TileClockGater(
  ...
  input         auto_clock_gater_in_0_member_allClocks_bus_clock,
                auto_clock_gater_in_0_member_allClocks_bus_reset,
                auto_clock_gater_in_0_member_allClocks_uncore_clock,
                auto_clock_gater_in_0_member_allClocks_uncore_reset,
  output        auto_clock_gater_out_member_allClocks_bus_clock,
                auto_clock_gater_out_member_allClocks_bus_reset,
                auto_clock_gater_out_member_allClocks_uncore_clock,
  ...
  assign out_woready_1 = auto_clock_gater_in_1_a_valid & auto_clock_gater_in_1_d_ready & ~out_front_bits_read & _out_out_bits_data_T_1;
  ...
  AsyncResetRegVec_w1_i1 regs_0 (
    ...
    .io_q  (_regs_0_io_q),
    .io_en (out_woready_1 & auto_clock_gater_in_1_a_bits_mask[0])
  );
  AsyncResetRegVec_w1_i1 regs_1 (
    .clock (clock),
    .reset (auto_clock_gater_in_0_member_allClocks_bus_reset),
    .io_d  (auto_clock_gater_in_1_a_bits_data[32]),
    .io_q  (_regs_1_io_q),
    .io_en (out_woready_1 & auto_clock_gater_in_1_a_bits_mask[4])
  );
  ...
  assign auto_clock_gater_in_1_d_bits_data = {31'h0, _out_out_bits_data_T_1 ? {_regs_1_io_q, 31'h0, _regs_0_io_q} : 33'h0};
  assign auto_clock_gater_out_member_allClocks_bus_clock = auto_clock_gater_in_0_member_allClocks_bus_clock;
  assign auto_clock_gater_out_member_allClocks_bus_reset = auto_clock_gater_in_0_member_allClocks_bus_reset;
