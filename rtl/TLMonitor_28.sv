...
module TLMonitor_28(
  ...
  wire [515:0]  _GEN = {506'h0, io_in_d_bits_source, 2'h0};
  wire [515:0]  _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN;
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_3 = io_in_a_bits_source[7:4] == 4'h2;
    ...
    wire         _GEN_17 = io_in_d_valid & d_first_1;
    wire         same_cycle_resp = io_in_a_valid & a_first_1 & io_in_a_bits_source == io_in_d_bits_source;
    wire         _GEN_18 = _GEN_17 & same_cycle_resp & ~reset;
    wire         _GEN_19 = _GEN_17 & ~same_cycle_resp & ~reset;
    wire [128:0] _GEN_20 = inflight >> io_in_a_bits_source;
    wire [128:0] _GEN_21 = inflight >> io_in_d_bits_source;
    wire [515:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN;
    always @(posedge clock) begin
      ...
      if (_GEN_2 & ~((_GEN_3 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_4 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_4) & io_in_a_bits_address[16])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_7 & ~((_GEN_3 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_4 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_4) & io_in_a_bits_address[16])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_8 & ~(io_in_a_bits_source[7:4] == 4'h4 | _GEN_3 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_8 & ~(io_in_a_bits_size != 3'h7 & io_in_a_bits_address[16])) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (io_in_d_valid & ~reset & ~(io_in_d_bits_source[7:4] == 4'h4 | io_in_d_bits_source[7:4] == 4'h2 & io_in_d_bits_source[3:0] < 4'h9 | io_in_d_bits_source == 8'h29 | io_in_d_bits_source == 8'h30 | io_in_d_bits_source[7:4] == 4'h0 & io_in_d_bits_source[3:0] < 4'h9 | io_in_d_bits_source == 8'h9 | io_in_d_bits_source == 8'h10 | io_in_d_bits_source == 8'h80)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_19 & io_in_d_bits_size != _a_size_lookup_T_1[3:1]) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/devices/tilelink/BootROM.scala:86:68)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_17 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [12:0]   _GEN_22 = {10'h0, io_in_d_bits_size};
  wire [12:0]   _d_first_beats1_decode_T_1 = 13'h3F << _GEN_22;
  wire [12:0]   _d_first_beats1_decode_T_5 = 13'h3F << _GEN_22;
  wire [2050:0] _GEN_23 = {2041'h0, io_in_a_bits_source, 2'h0};
  wire [2062:0] _GEN_24 = {2053'h0, io_in_d_bits_source, 2'h0};
  wire [255:0]  _d_clr_T = 256'h1 << io_in_d_bits_source;
  wire [255:0]  _a_set_T = 256'h1 << io_in_a_bits_source;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << _GEN_24;
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_0 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_23;
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hF << _GEN_24;
  wire [2050:0] _a_sizes_set_T_1 = {2047'h0, _GEN_0 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_23;
  wire          _d_first_T_2 = io_in_d_ready & io_in_d_valid;
  wire          _GEN_25 = _d_first_T_2 & d_first_1;
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_0 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_25 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_0 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_25 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_0 ? _a_sizes_set_T_1[515:0] : 516'h0)) & ~(_GEN_25 ? _d_sizes_clr_T_5[515:0] : 516'h0);
