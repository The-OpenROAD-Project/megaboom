...
module TLMonitor_27(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_11 = io_in_a_bits_size != 3'h7;
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_3 & ~(_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_8 & ~(_GEN_4 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_5)) begin
        if (`ASSERT_VERBOSE_COND_)
