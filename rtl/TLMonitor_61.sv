...
module TLMonitor_61(
  ...
  `ifndef SYNTHESIS
    ...
    wire [2063:0] _GEN_20 = inflight >> io_in_a_bits_source;
    wire [2063:0] _GEN_21 = inflight >> io_in_d_bits_source;
    ...
    always @(posedge clock) begin
      ...
      if (io_in_d_valid & ~reset & io_in_d_bits_source > 12'h80F) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [32782:0] _GEN_22 = {32769'h0, io_in_d_bits_source, 2'h0};
  wire [4095:0]  _d_clr_T = 4096'h1 << io_in_d_bits_source;
  wire [4095:0]  _a_set_T = 4096'h1 << io_in_a_bits_source;
  wire [32782:0] _d_opcodes_clr_T_5 = 32783'hF << _GEN_22;
  wire [32770:0] _a_opcodes_set_T_1 = {32767'h0, _GEN_0 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {32757'h0, io_in_a_bits_source, 2'h0};
  wire [32782:0] _d_sizes_clr_T_5 = 32783'hF << _GEN_22;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_0 ? _a_set_T[2063:0] : 2064'h0)) & ~(_GEN_23 ? _d_clr_T[2063:0] : 2064'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_0 ? _a_opcodes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_23 ? _d_opcodes_clr_T_5[8255:0] : 8256'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_0 ? _a_sizes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_23 ? _d_sizes_clr_T_5[8255:0] : 8256'h0);
