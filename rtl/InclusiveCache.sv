...
module InclusiveCache(
  ...
  input  [11:0] auto_ctrls_ctrl_in_a_bits_source,
  ...
  output [11:0] auto_ctrls_ctrl_in_d_bits_source,
  ...
  wire [6:0]  _inclusive_cache_bank_sched_io_in_b_bits_source;
  ...
  wire [6:0]  _inclusive_cache_bank_sched_io_in_d_bits_source;
  ...
  assign auto_in_b_bits_source = _inclusive_cache_bank_sched_io_in_b_bits_source;
