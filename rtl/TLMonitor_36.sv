...
module TLMonitor_36(
  ...
  reg  [319:0]  inflight_sizes;
  reg  [2:0]    a_first_counter_1;
  wire          a_first_1 = a_first_counter_1 == 3'h0;
  reg  [2:0]    d_first_counter_1;
  wire          d_first_1 = d_first_counter_1 == 3'h0;
  wire [319:0]  _GEN_1 = {311'h0, io_in_d_bits_source, 2'h0};
  wire [319:0]  _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_1;
  wire [127:0]  _GEN_2 = {121'h0, io_in_a_bits_source};
  ...
  wire [127:0]  _GEN_6 = {121'h0, io_in_c_bits_source};
  ...
  `ifndef SYNTHESIS
    wire         _source_ok_WIRE_2 = io_in_a_bits_source == 7'h30;
    wire         _source_ok_WIRE_4 = io_in_a_bits_source == 7'h10;
    wire         source_ok = io_in_a_bits_source[6:4] == 3'h4 | io_in_a_bits_source[6:4] == 3'h2 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4;
    ...
    wire         _GEN_10 = io_in_a_bits_source[6:4] == 3'h4;
    wire         _GEN_11 = io_in_a_bits_source[6:4] == 3'h2;
    wire         _GEN_12 = io_in_a_bits_size == 3'h6;
    ...
    wire         _GEN_20 = io_in_a_bits_size != 3'h7 & _GEN_13;
    ...
    wire         _GEN_24 = ~(io_in_a_bits_size[2]) & _GEN_13;
    ...
    wire         source_ok_1 = io_in_d_bits_source[6:4] == 3'h4 | io_in_d_bits_source[6:4] == 3'h2 & io_in_d_bits_source[3:0] < 4'h9 | io_in_d_bits_source == 7'h30 | io_in_d_bits_source[6:4] == 3'h0 & io_in_d_bits_source[3:0] < 4'h9 | io_in_d_bits_source == 7'h10;
    ...
    wire [1:0]   _GEN_37 = {io_in_b_bits_address[32], ~(io_in_b_bits_address[31])};
    wire         _GEN_38 = io_in_b_bits_address[32:31] != 2'h2;
    wire [16:0]  _GEN_39 = {io_in_b_bits_address[32:28], io_in_b_bits_address[27:16] ^ 12'h800};
    wire [5:0]   _GEN_40 = {io_in_b_bits_source[6:4] == 3'h2 & io_in_b_bits_source[3:0] < 4'h9, 5'h0} | (io_in_b_bits_source == 7'h30 ? 6'h30 : 6'h0);
    wire         _GEN_41 = io_in_b_valid & ~reset;
    wire         _source_ok_WIRE_2_2 = io_in_c_bits_source == 7'h30;
    wire         _source_ok_WIRE_2_4 = io_in_c_bits_source == 7'h10;
    wire         source_ok_2 = io_in_c_bits_source[6:4] == 3'h4 | io_in_c_bits_source[6:4] == 3'h2 & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_2 | ~(|(io_in_c_bits_source[6:4])) & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_4;
    wire [12:0]  _is_aligned_mask_T_7 = 13'h3F << _GEN_0;
    wire [5:0]   _GEN_42 = io_in_c_bits_address[5:0] & ~(_is_aligned_mask_T_7[5:0]);
    wire [1:0]   _GEN_43 = {io_in_c_bits_address[32], ~(io_in_c_bits_address[31])};
    wire         _GEN_44 = io_in_c_bits_address[32:31] != 2'h2;
    wire [16:0]  _GEN_45 = {io_in_c_bits_address[32:28], io_in_c_bits_address[27:16] ^ 12'h800};
    wire         address_ok_1 = ~(|_GEN_43) | ~_GEN_44 | ~(|_GEN_45);
    wire         _GEN_46 = io_in_c_valid & io_in_c_bits_opcode == 3'h4 & ~reset;
    wire         _GEN_47 = io_in_c_bits_size < 3'h3;
    wire         _GEN_48 = io_in_c_valid & io_in_c_bits_opcode == 3'h5 & ~reset;
    wire         _GEN_49 = io_in_c_bits_source[6:4] == 3'h4;
    wire         _GEN_50 = io_in_c_bits_source[6:4] == 3'h2;
    wire         _GEN_51 = io_in_c_bits_size == 3'h6;
    wire         _GEN_52 = ~(|_GEN_45) | ~(|_GEN_43) | ~_GEN_44;
    wire         _GEN_53 = _GEN_51 & _GEN_52;
    wire         _GEN_54 = io_in_c_valid & io_in_c_bits_opcode == 3'h6 & ~reset;
    wire         _GEN_55 = io_in_c_valid & (&io_in_c_bits_opcode) & ~reset;
    wire         _GEN_56 = io_in_c_valid & io_in_c_bits_opcode == 3'h0 & ~reset;
    wire         _GEN_57 = io_in_c_valid & io_in_c_bits_opcode == 3'h1 & ~reset;
    wire         _GEN_58 = io_in_c_valid & io_in_c_bits_opcode == 3'h2 & ~reset;
    wire         _GEN_59 = io_in_e_valid & ~reset;
    wire         _GEN_60 = io_in_a_valid & (|a_first_counter) & ~reset;
    wire         _GEN_61 = io_in_d_valid & (|d_first_counter) & ~reset;
    wire         _GEN_62 = io_in_b_valid & (|b_first_counter) & ~reset;
    wire         _GEN_63 = io_in_c_valid & (|c_first_counter) & ~reset;
    wire         _same_cycle_resp_T_1 = io_in_a_valid & a_first_1;
    wire [127:0] _a_set_wo_ready_T = 128'h1 << _GEN_2;
    wire [79:0]  a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[79:0] : 80'h0;
    wire         _GEN_64 = io_in_d_valid & d_first_1;
    wire         _GEN_65 = _GEN_64 & ~d_release_ack;
    wire         same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;
    wire [79:0]  _GEN_66 = {73'h0, io_in_d_bits_source};
    wire         _GEN_67 = _GEN_65 & same_cycle_resp & ~reset;
    wire         _GEN_68 = _GEN_65 & ~same_cycle_resp & ~reset;
    wire         _same_cycle_resp_T_3 = io_in_c_valid & c_first_1;
    wire [127:0] _c_set_wo_ready_T = 128'h1 << _GEN_6;
    wire [79:0]  c_set_wo_ready = _same_cycle_resp_T_3 & _GEN_5 ? _c_set_wo_ready_T[79:0] : 80'h0;
    wire         _GEN_69 = io_in_d_valid & d_first_2;
    wire         _GEN_70 = _GEN_69 & d_release_ack;
    ...
    wire [79:0]  _GEN_71 = inflight >> io_in_a_bits_source;
    wire [79:0]  _GEN_72 = inflight >> _GEN_66;
    wire [319:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_1;
    wire [127:0] _d_clr_wo_ready_T = 128'h1 << _GEN_4;
    wire [79:0]  _GEN_73 = inflight_1 >> io_in_c_bits_source;
    wire [79:0]  _GEN_74 = inflight_1 >> _GEN_66;
    wire [319:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_1;
    wire [127:0] _d_clr_wo_ready_T_1 = 128'h1 << _GEN_4;
    wire [6:0]   _GEN_75 = inflight_2 >> io_in_d_bits_sink;
    wire [6:0]   _GEN_76 = (d_set | inflight_2) >> io_in_e_bits_sink;
    always @(posedge clock) begin
      if (_GEN_15 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_14)) begin
      ...
      if (_GEN_15 & ~((_GEN_11 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_12 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_12) & _GEN_13)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_18 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_14)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_18 & ~((_GEN_11 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_12 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_12) & _GEN_13)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_19 & ~(_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_22 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_20)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_23 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_20)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_25 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_24)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_26 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_24)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_27 & ~((_GEN_10 | _GEN_11 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_4) & _GEN_20)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_30 & (&io_in_d_bits_sink)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_32 & (&io_in_d_bits_sink)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_41 & ~((io_in_b_bits_source[6:4] == 3'h2 & io_in_b_bits_source[3:0] < 4'h9 | io_in_b_bits_source[6:4] == 3'h0 & io_in_b_bits_source[3:0] < 4'h9) & (~(|_GEN_39) | ~(|_GEN_37) | ~_GEN_38))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_41 & ~(~(|_GEN_37) | ~_GEN_38 | ~(|_GEN_39))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_41 & {io_in_b_bits_source[6:4] == 3'h4, _GEN_40[5], _GEN_40[4:0] | {io_in_b_bits_source == 7'h10, 4'h0}} != io_in_b_bits_source) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'B' channel Probe carries source that is not first source (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_41 & (|(io_in_b_bits_address[5:0]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_41 & (&io_in_b_bits_param)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_46 & io_in_c_bits_corrupt) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_54 & ~((_GEN_49 | _GEN_50 & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_2 | ~(|(io_in_c_bits_source[6:4])) & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_4) & _GEN_53)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_54 & ~((_GEN_50 & io_in_c_bits_source[3:0] < 4'h9 & _GEN_51 | ~(|(io_in_c_bits_source[6:4])) & io_in_c_bits_source[3:0] < 4'h9 & _GEN_51) & _GEN_52)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_54 & (&(io_in_c_bits_param[2:1]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_55 & ~((_GEN_49 | _GEN_50 & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_2 | ~(|(io_in_c_bits_source[6:4])) & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_4) & _GEN_53)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_55 & ~((_GEN_50 & io_in_c_bits_source[3:0] < 4'h9 & _GEN_51 | ~(|(io_in_c_bits_source[6:4])) & io_in_c_bits_source[3:0] < 4'h9 & _GEN_51) & _GEN_52)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'C' channel carries Release from a client which does not support Probe (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:42 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      ...
      if (_GEN_55 & (&(io_in_c_bits_param[2:1]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_56 & (|io_in_c_bits_param)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_56 & io_in_c_bits_corrupt) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_57 & (|io_in_c_bits_param)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_58 & (|io_in_c_bits_param)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_58 & io_in_c_bits_corrupt) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_59 & (&io_in_e_bits_sink)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_60 & io_in_a_bits_opcode != opcode) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_60 & io_in_a_bits_param != param) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_60 & io_in_a_bits_size != size) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_60 & io_in_a_bits_source != source) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_60 & io_in_a_bits_address != address) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & io_in_d_bits_opcode != opcode_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & io_in_d_bits_param != param_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & io_in_d_bits_size != size_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & io_in_d_bits_source != source_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & io_in_d_bits_sink != sink) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & io_in_d_bits_denied != denied) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_62 & io_in_b_bits_param != param_2) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_62 & io_in_b_bits_source != source_2) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'B' channel source changed within multibeat operation (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:42 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_62 & io_in_b_bits_address != address_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_63 & io_in_c_bits_opcode != opcode_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_63 & io_in_c_bits_param != param_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_63 & io_in_c_bits_size != size_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_63 & io_in_c_bits_source != source_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_63 & io_in_c_bits_address != address_2) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_3 & ~reset & _GEN_71[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_65 & ~reset & ~(_GEN_72[0] | same_cycle_resp)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_67 & ~(io_in_d_bits_opcode == casez_tmp | io_in_d_bits_opcode == casez_tmp_0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_67 & io_in_a_bits_size != io_in_d_bits_size) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_68 & ~(io_in_d_bits_opcode == casez_tmp_1 | io_in_d_bits_opcode == casez_tmp_2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_68 & io_in_d_bits_size != _a_size_lookup_T_1[3:1]) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_64 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & ~(a_set_wo_ready != (_GEN_65 ? _d_clr_wo_ready_T[79:0] : 80'h0) | a_set_wo_ready == 80'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_7 & ~reset & _GEN_73[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_70 & ~reset & ~(_GEN_74[0] | same_cycle_resp_1)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_70 & same_cycle_resp_1 & ~reset & io_in_d_bits_size != io_in_c_bits_size) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_70 & ~same_cycle_resp_1 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:126:13)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_69 & c_first_1 & io_in_c_valid & io_in_c_bits_source == io_in_d_bits_source & d_release_ack & ~(io_in_c_bits_opcode == 3'h4 | io_in_c_bits_opcode == 3'h5) & ~reset & ~(~io_in_d_ready | io_in_c_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if ((|c_set_wo_ready) & ~reset & c_set_wo_ready == (_GEN_70 ? _d_clr_wo_ready_T_1[79:0] : 80'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_8 & ~reset & _GEN_75[0]) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [12:0]   _GEN_77 = {10'h0, io_in_d_bits_size};
  wire [12:0]   _d_first_beats1_decode_T_1 = 13'h3F << _GEN_77;
  wire [12:0]   _d_first_beats1_decode_T_5 = 13'h3F << _GEN_77;
  wire [12:0]   _d_first_beats1_decode_T_9 = 13'h3F << _GEN_77;
  wire [12:0]   _d_first_beats1_decode_T_13 = 13'h3F << _GEN_77;
  wire [12:0]   _c_first_beats1_decode_T_1 = 13'h3F << _GEN_0;
  wire [12:0]   _c_first_beats1_decode_T_5 = 13'h3F << _GEN_0;
  wire [1026:0] _GEN_78 = {1018'h0, io_in_a_bits_source, 2'h0};
  wire          _GEN_79 = _d_first_T_3 & d_first_1 & ~d_release_ack;
  wire [1038:0] _GEN_80 = {1030'h0, io_in_d_bits_source, 2'h0};
  wire          _GEN_81 = _d_first_T_3 & d_first_2 & d_release_ack;
  wire [127:0]  _d_clr_T = 128'h1 << _GEN_4;
  wire [127:0]  _a_set_T = 128'h1 << _GEN_2;
  wire [1038:0] _d_opcodes_clr_T_5 = 1039'hF << _GEN_80;
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _GEN_3 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_78;
  wire [1038:0] _d_sizes_clr_T_5 = 1039'hF << _GEN_80;
  wire [1026:0] _a_sizes_set_T_1 = {1023'h0, _GEN_3 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_78;
  wire [127:0]  _d_clr_T_1 = 128'h1 << _GEN_4;
  wire [127:0]  _c_set_T = 128'h1 << _GEN_6;
  wire [1038:0] _d_sizes_clr_T_11 = 1039'hF << _GEN_80;
  wire [1026:0] _c_sizes_set_T_1 = {1023'h0, _GEN_7 ? {io_in_c_bits_size, 1'h1} : 4'h0} << {1018'h0, io_in_c_bits_source, 2'h0};
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_3 ? _a_set_T[79:0] : 80'h0)) & ~(_GEN_79 ? _d_clr_T[79:0] : 80'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_3 ? _a_opcodes_set_T_1[319:0] : 320'h0)) & ~(_GEN_79 ? _d_opcodes_clr_T_5[319:0] : 320'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_3 ? _a_sizes_set_T_1[319:0] : 320'h0)) & ~(_GEN_79 ? _d_sizes_clr_T_5[319:0] : 320'h0);
      if (_a_first_T_1 | _d_first_T_3)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= (inflight_1 | (_GEN_7 ? _c_set_T[79:0] : 80'h0)) & ~(_GEN_81 ? _d_clr_T_1[79:0] : 80'h0);
      inflight_sizes_1 <= (inflight_sizes_1 | (_GEN_7 ? _c_sizes_set_T_1[319:0] : 320'h0)) & ~(_GEN_81 ? _d_sizes_clr_T_11[319:0] : 320'h0);
