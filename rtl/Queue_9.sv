...
module Queue_9(
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[31:18];
  assign io_deq_bits_mask = _ram_ext_R0_data[39:32];
  assign io_deq_bits_data = _ram_ext_R0_data[103:40];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[104];
endmodule
