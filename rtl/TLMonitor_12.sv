...
module TLMonitor_12(
  ...
  `ifndef SYNTHESIS
    ...
    wire          _GEN_17 = io_in_d_bits_source > 12'h80F;
    ...
    wire [2063:0] _GEN_25 = {2052'h0, io_in_d_bits_source};
    ...
    wire [2063:0] _GEN_30 = inflight >> io_in_a_bits_source;
    wire [2063:0] _GEN_31 = inflight >> _GEN_25;
    wire [8255:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN;
    wire [2063:0] _GEN_32 = inflight_1 >> _GEN_25;
  ...
  wire [4095:0]  _GEN_33 = {4084'h0, io_in_d_bits_source};
  wire [32782:0] _GEN_34 = {32769'h0, io_in_d_bits_source, 2'h0};
  wire [4095:0]  _d_clr_T = 4096'h1 << _GEN_33;
  wire [4095:0]  _a_set_T = 4096'h1 << io_in_a_bits_source;
  wire [32782:0] _d_opcodes_clr_T_5 = 32783'hF << _GEN_34;
  wire [32770:0] _a_opcodes_set_T_1 = {32767'h0, _GEN_0 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {32757'h0, io_in_a_bits_source, 2'h0};
  wire [32782:0] _d_sizes_clr_T_5 = 32783'hF << _GEN_34;
  wire [32769:0] _a_sizes_set_T_1 = {32767'h0, _GEN_0 ? {io_in_a_bits_size, 1'h1} : 3'h0} << {32756'h0, io_in_a_bits_source, 2'h0};
  wire [4095:0]  _d_clr_T_1 = 4096'h1 << _GEN_33;
  wire [32782:0] _d_sizes_clr_T_11 = 32783'hF << _GEN_34;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_0 ? _a_set_T[2063:0] : 2064'h0)) & ~(_GEN_35 ? _d_clr_T[2063:0] : 2064'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_0 ? _a_opcodes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_35 ? _d_opcodes_clr_T_5[8255:0] : 8256'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_0 ? _a_sizes_set_T_1[8255:0] : 8256'h0)) & ~(_GEN_35 ? _d_sizes_clr_T_5[8255:0] : 8256'h0);
      ...
      inflight_1 <= inflight_1 & ~(_GEN_36 ? _d_clr_T_1[2063:0] : 2064'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_36 ? _d_sizes_clr_T_11[8255:0] : 8256'h0);
