  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_41 & {io_in_b_bits_source[6:4] == 3'h4, _GEN_40[5], _GEN_40[4:0] | {io_in_b_bits_source == 7'h10, 4'h0}} != io_in_b_bits_source) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'B' channel Probe carries source that is not first source (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:125:26)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      ...
      if (_GEN_62 & io_in_b_bits_source != source_2) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'B' channel source changed within multibeat operation (connected at generators/sifive-cache/design/craft/inclusivecache/src/Configs.scala:125:26)\n    at Monitor.scala:42 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
