...
module TLMonitor_19(
  ...
  reg           denied;
  reg  [128:0]  inflight;
  reg  [515:0]  inflight_opcodes;
  reg  [1031:0] inflight_sizes;
  reg  [8:0]    a_first_counter_1;
  wire          a_first_1 = a_first_counter_1 == 9'h0;
  reg  [8:0]    d_first_counter_1;
  wire          d_first_1 = d_first_counter_1 == 9'h0;
  wire [515:0]  _a_opcode_lookup_T_1 = inflight_opcodes >> {506'h0, io_in_d_bits_source, 2'h0};
  ...
  reg  [31:0]   watchdog;
  reg  [128:0]  inflight_1;
  reg  [1031:0] inflight_sizes_1;
  reg  [8:0]    d_first_counter_2;
  wire          d_first_2 = d_first_counter_2 == 9'h0;
  reg  [31:0]   watchdog_1;
  `ifndef SYNTHESIS
    wire          _source_ok_WIRE_2 = io_in_a_bits_source == 8'h29;
    wire          _source_ok_WIRE_3 = io_in_a_bits_source == 8'h30;
    wire          _source_ok_WIRE_5 = io_in_a_bits_source == 8'h9;
    wire          _source_ok_WIRE_6 = io_in_a_bits_source == 8'h10;
    wire          _source_ok_WIRE_7 = io_in_a_bits_source == 8'h80;
    wire          source_ok = io_in_a_bits_source[7:4] == 4'h4 | io_in_a_bits_source[7:4] == 4'h2 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7;
    ...
    wire          _GEN_6 = io_in_a_bits_source[7:4] == 4'h2;
    ...
    wire          _GEN_14 = _GEN_4 & (_GEN_8 | _GEN_9 | _GEN_10 | _GEN_11 | _GEN_12 | _GEN_13 | (&(io_in_a_bits_address[27:26])));
    ...
    wire          _GEN_18 = io_in_a_bits_source[7:4] == 4'h4;
    wire          _GEN_19 = io_in_a_valid & io_in_a_bits_opcode == 3'h4 & ~reset;
    wire          _GEN_20 = _GEN_4 & _GEN_9;
    wire          _GEN_21 = io_in_a_bits_size < 4'h7;
    wire          _GEN_22 = io_in_a_bits_mask != mask;
    wire          _GEN_23 = _GEN_20 | _GEN_21 & (_GEN_8 | _GEN_11 | _GEN_12 | _GEN_13 | (&(io_in_a_bits_address[27:26])));
    wire          _GEN_24 = io_in_a_valid & io_in_a_bits_opcode == 3'h0 & ~reset;
    wire          _GEN_25 = io_in_a_valid & io_in_a_bits_opcode == 3'h1 & ~reset;
    wire          _GEN_26 = io_in_a_bits_size < 4'h4 & {io_in_a_bits_address[27:14], ~(io_in_a_bits_address[12])} == 15'h0;
    ...
    wire          source_ok_1 = io_in_d_bits_source[7:4] == 4'h4 | io_in_d_bits_source[7:4] == 4'h2 & io_in_d_bits_source[3:0] < 4'h9 | io_in_d_bits_source == 8'h29 | io_in_d_bits_source == 8'h30 | io_in_d_bits_source[7:4] == 4'h0 & io_in_d_bits_source[3:0] < 4'h9 | io_in_d_bits_source == 8'h9 | io_in_d_bits_source == 8'h10 | io_in_d_bits_source == 8'h80;
    ...
    wire [1031:0] _GEN_41 = {1021'h0, io_in_d_bits_source, 3'h0};
    wire          _same_cycle_resp_T_1 = io_in_a_valid & a_first_1;
    wire [255:0]  _a_set_wo_ready_T = 256'h1 << _GEN_0;
    wire [128:0]  a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[128:0] : 129'h0;
    wire          _GEN_42 = io_in_d_valid & d_first_1;
    wire          _GEN_43 = _GEN_42 & ~d_release_ack;
    wire          same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;
    wire [128:0]  _GEN_44 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0]  _GEN_49 = inflight >> io_in_a_bits_source;
    wire [128:0]  _GEN_50 = inflight >> _GEN_44;
    wire [1031:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_41;
    wire [255:0]  _d_clr_wo_ready_T = 256'h1 << _GEN_2;
    wire [128:0]  _GEN_51 = inflight_1 >> _GEN_44;
    wire [1031:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_41;
    always @(posedge clock) begin
      ...
      if (_GEN_5 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & _GEN_14)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_17 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & _GEN_14)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_19 & ~(_GEN_4 & (_GEN_18 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_19 & ~(_GEN_20 | _GEN_21 & (_GEN_8 | _GEN_10 | _GEN_11 | _GEN_12 | _GEN_13 | (&(io_in_a_bits_address[27:26]))))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_24 & ~(_GEN_4 & (_GEN_18 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_23)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_25 & ~(_GEN_4 & (_GEN_18 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_23)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_27 & ~(_GEN_4 & (_GEN_18 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_26)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_28 & ~(_GEN_4 & (_GEN_18 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_26)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_29 & ~(_GEN_4 & (_GEN_18 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_20)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_1 & ~reset & _GEN_49[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_43 ? _d_clr_wo_ready_T[128:0] : 129'h0) | a_set_wo_ready == 129'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(inflight == 129'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(inflight_1 == 129'h0 | _plusarg_reader_1_out == 32'h0 | watchdog_1 < _plusarg_reader_1_out)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: TileLink timeout expired (connected at generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:55:7)\n    at Monitor.scala:42 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
  ...
  wire [2062:0] _GEN_53 = {2052'h0, io_in_d_bits_source, 3'h0};
  wire [255:0]  _d_clr_T = 256'h1 << _GEN_2;
  wire [255:0]  _a_set_T = 256'h1 << _GEN_0;
  wire [2062:0] _d_opcodes_clr_T_5 = 2063'hF << {2053'h0, io_in_d_bits_source, 2'h0};
  wire [2050:0] _a_opcodes_set_T_1 = {2047'h0, _GEN_1 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {2041'h0, io_in_a_bits_source, 2'h0};
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hFF << _GEN_53;
  wire [2051:0] _a_sizes_set_T_1 = {2047'h0, _GEN_1 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {2041'h0, io_in_a_bits_source, 3'h0};
  wire [255:0]  _d_clr_T_1 = 256'h1 << _GEN_2;
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hFF << _GEN_53;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= 129'h0;
      inflight_opcodes <= 516'h0;
      inflight_sizes <= 1032'h0;
      a_first_counter_1 <= 9'h0;
      d_first_counter_1 <= 9'h0;
      watchdog <= 32'h0;
      inflight_1 <= 129'h0;
      inflight_sizes_1 <= 1032'h0;
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_54 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_54 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[1031:0] : 1032'h0)) & ~(_GEN_54 ? _d_sizes_clr_T_5[1031:0] : 1032'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_55 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_55 ? _d_sizes_clr_T_11[1031:0] : 1032'h0);
    end
