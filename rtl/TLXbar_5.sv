...
module TLXbar_5(
  ...
  wire        requestAIO_0_1 = {auto_in_a_bits_address[27], _GEN[9], auto_in_a_bits_address[20], _GEN[0], auto_in_a_bits_address[13:12]} == 6'h0;
  wire        requestAIO_0_2 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[13], ~(auto_in_a_bits_address[12])} == 6'h0;
  wire        requestAIO_0_4 = {auto_in_a_bits_address[27], ~(auto_in_a_bits_address[25]), auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 4'h0;
  wire        requestAIO_0_5 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[13:12]} == 6'h0;
  wire        requestAIO_0_6 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], ~(auto_in_a_bits_address[16])} == 4'h0;
  ...
  wire [7:0]  _in_0_d_bits_WIRE_7 = (muxState_0 ? auto_out_0_d_bits_source : 8'h0) | (muxState_1 ? auto_out_1_d_bits_source : 8'h0) | (muxState_2 ? auto_out_2_d_bits_source : 8'h0) | (muxState_3 ? auto_out_3_d_bits_source : 8'h0) | (muxState_4 ? auto_out_4_d_bits_source : 8'h0) | (muxState_5 ? auto_out_5_d_bits_source : 8'h0) | (muxState_6 ? auto_out_6_d_bits_source : 8'h0) | (muxState_7 ? auto_out_7_d_bits_source : 8'h0);
  ...
  assign auto_in_d_bits_data = (muxState_0 ? auto_out_0_d_bits_data : 64'h0) | (muxState_1 ? auto_out_1_d_bits_data : 64'h0) | (muxState_2 ? auto_out_2_d_bits_data : 64'h0) | (muxState_4 ? auto_out_4_d_bits_data : 64'h0) | (muxState_5 ? auto_out_5_d_bits_data : 64'h0) | (muxState_6 ? auto_out_6_d_bits_data : 64'h0) | (muxState_7 ? auto_out_7_d_bits_data : 64'h0);
  ...
  assign auto_out_2_a_bits_address = auto_in_a_bits_address[12:0];
