...
module TLMonitor_30(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_8 = {io_in_a_bits_address[20:17] ^ 4'h8, io_in_a_bits_address[15:12]} == 8'h0;
    ...
    wire         _GEN_14 = io_in_a_bits_size != 3'h7 & _GEN_8;
    wire         _GEN_15 = io_in_a_bits_mask != mask;
    wire         _GEN_16 = io_in_a_valid & io_in_a_bits_opcode == 3'h0 & ~reset;
    wire         _GEN_17 = io_in_a_valid & io_in_a_bits_opcode == 3'h1 & ~reset;
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_13 & ~(_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_16 & ~((_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_14)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_17 & ~((_GEN_12 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_14)) begin
        if (`ASSERT_VERBOSE_COND_)
