...
module TLB(
  ...
  wire        legal_address = {mpu_ppn[27:2], ~(mpu_ppn[1:0])} == 28'h0 | {mpu_ppn[27:14], _GEN} == 28'h0 | {mpu_ppn[27:1], ~(mpu_ppn[0])} == 28'h0 | {mpu_ppn[27:16], ~(mpu_ppn[15:14])} == 14'h0 | {mpu_ppn[27:14], _GEN_0} == 24'h0 | ~(|mpu_ppn) | {mpu_ppn[27:5], ~(mpu_ppn[4])} == 24'h0 | {mpu_ppn[27:9], _GEN_1} == 28'h0 | {mpu_ppn[27:9], mpu_ppn[8:0] ^ 9'h110} == 28'h0 | {mpu_ppn[27:20], ~(mpu_ppn[19])} == 9'h0 | {mpu_ppn[27:21], mpu_ppn[20:19] ^ 2'h2} == 9'h0 | {mpu_ppn[27:16], _GEN_2} == 24'h0;
  wire [1:0]  _GEN_3 = {mpu_ppn[20], ~(mpu_ppn[19])};
  wire        _GEN_4 = mpu_ppn[20:19] != 2'h2;
  wire        deny_access_to_debug = ~(mpu_priv[2]) & ~(|mpu_ppn);
  wire        newEntry_px = legal_address & ({mpu_ppn[20:19], mpu_ppn[15:13], mpu_ppn[8], mpu_ppn[4], mpu_ppn[1:0]} == 9'h0 | {mpu_ppn[20:19], mpu_ppn[15:13], mpu_ppn[8], mpu_ppn[4], ~(mpu_ppn[1:0])} == 9'h0 | {mpu_ppn[20:19], mpu_ppn[15:13], mpu_ppn[8], ~(mpu_ppn[4])} == 7'h0 | {mpu_ppn[20:19], _GEN_2[11:9], mpu_ppn[8], mpu_ppn[4]} == 7'h0 | ~(|_GEN_3) | ~_GEN_4) & ~deny_access_to_debug & _pmp_io_x;
  ...
  wire [4:0]  _GEN_6 = {mpu_ppn[20:19], mpu_ppn[15], mpu_ppn[8], mpu_ppn[4]};
  wire [5:0]  _GEN_7 = {mpu_ppn[20:19], mpu_ppn[15], mpu_ppn[13], _GEN_1[8], mpu_ppn[0]};
  wire [6:0]  _GEN_8 = {mpu_ppn[20:19], mpu_ppn[15], _GEN[13], mpu_ppn[8], _GEN[4], mpu_ppn[0]};
  wire [2:0]  _GEN_9 = {mpu_ppn[20:19], _GEN_2[11]};
  wire [5:0]  _GEN_10 = {mpu_ppn[20:19], _GEN_2[11], mpu_ppn[13], mpu_ppn[8], mpu_ppn[4]};
  wire        newEntry_pw = legal_address & (~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10) | ~(|_GEN_3) | ~_GEN_4) & ~deny_access_to_debug & _pmp_io_w;
  wire        newEntry_ppp = legal_address & (~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10) | ~(|_GEN_3) | ~_GEN_4);
  wire        newEntry_pal = legal_address & (~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10) | ~(|_GEN_3) | ~_GEN_4);
  wire        newEntry_paa = legal_address & (~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10) | ~(|_GEN_3) | ~_GEN_4);
  wire        newEntry_eff = legal_address & ({mpu_ppn[20:19], mpu_ppn[15:13], mpu_ppn[8], mpu_ppn[4], mpu_ppn[1]} == 8'h0 | {mpu_ppn[20:19], mpu_ppn[15:13], _GEN_1[8], mpu_ppn[1:0]} == 8'h0 | {mpu_ppn[20:19], mpu_ppn[15:14], _GEN_0[9], mpu_ppn[8], mpu_ppn[4]} == 7'h0 | {mpu_ppn[20:19], mpu_ppn[15:14], _GEN[13], mpu_ppn[8], _GEN[4], mpu_ppn[1:0]} == 9'h0 | {mpu_ppn[20:19], ~(mpu_ppn[15:14])} == 4'h0);
  ...
  wire        _GEN_11 = io_ptw_resp_valid & ~io_ptw_resp_bits_homogeneous;
  wire        _GEN_12 = _GEN_11 | special_entry_valid_0;
  wire        _GEN_13 = ~(io_ptw_resp_bits_level[1]) & waddr == 2'h0;
  wire        _GEN_14 = io_ptw_resp_valid & io_ptw_resp_bits_homogeneous & _GEN_13;
  wire        _GEN_15 = _GEN_14 ? ~invalidate_refill : superpage_entries_0_valid_0;
  wire        _GEN_16 = ~(io_ptw_resp_bits_level[1]) & waddr == 2'h1;
  wire        _GEN_17 = io_ptw_resp_valid & io_ptw_resp_bits_homogeneous & _GEN_16;
  wire        _GEN_18 = _GEN_17 ? ~invalidate_refill : superpage_entries_1_valid_0;
  wire        _GEN_19 = ~(io_ptw_resp_bits_level[1]) & waddr == 2'h2;
  wire        _GEN_20 = io_ptw_resp_valid & io_ptw_resp_bits_homogeneous & _GEN_19;
  wire        _GEN_21 = _GEN_20 ? ~invalidate_refill : superpage_entries_2_valid_0;
  wire        _GEN_22 = ~(io_ptw_resp_bits_level[1]) & (&waddr);
  wire        _GEN_23 = io_ptw_resp_valid & io_ptw_resp_bits_homogeneous & _GEN_22;
  wire        _GEN_24 = _GEN_23 ? ~invalidate_refill : superpage_entries_3_valid_0;
  wire [2:0]  waddr_1 = r_sectored_hit_valid ? r_sectored_hit_bits : r_sectored_repl_addr;
  wire        _GEN_25 = waddr_1 == 3'h0;
  wire        _GEN_26 = ~io_ptw_resp_bits_homogeneous | ~(io_ptw_resp_bits_level[1]);
  wire        _GEN_27 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_25;
  wire        _GEN_28 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_29 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_30 = r_refill_tag[1:0] == 2'h2;
  ...
  wire        _GEN_31 = _GEN_27 ? sectored_entries_0_0_valid_0 : ~invalidate_refill & (_GEN_28 | r_sectored_hit_valid & sectored_entries_0_0_valid_0);
  wire        _GEN_32 = _GEN_27 ? sectored_entries_0_0_valid_1 : ~invalidate_refill & (_GEN_29 | r_sectored_hit_valid & sectored_entries_0_0_valid_1);
  wire        _GEN_33 = _GEN_27 ? sectored_entries_0_0_valid_2 : ~invalidate_refill & (_GEN_30 | r_sectored_hit_valid & sectored_entries_0_0_valid_2);
  wire        _GEN_34 = _GEN_27 ? sectored_entries_0_0_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_0_valid_3);
  wire        _GEN_35 = waddr_1 == 3'h1;
  wire        _GEN_36 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_35;
  wire        _GEN_37 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_38 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_39 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_1_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_40 = _GEN_36 ? sectored_entries_0_1_valid_0 : ~invalidate_refill & (_GEN_37 | r_sectored_hit_valid & sectored_entries_0_1_valid_0);
  wire        _GEN_41 = _GEN_36 ? sectored_entries_0_1_valid_1 : ~invalidate_refill & (_GEN_38 | r_sectored_hit_valid & sectored_entries_0_1_valid_1);
  wire        _GEN_42 = _GEN_36 ? sectored_entries_0_1_valid_2 : ~invalidate_refill & (_GEN_39 | r_sectored_hit_valid & sectored_entries_0_1_valid_2);
  wire        _GEN_43 = _GEN_36 ? sectored_entries_0_1_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_1_valid_3);
  wire        _GEN_44 = waddr_1 == 3'h2;
  wire        _GEN_45 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_44;
  wire        _GEN_46 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_47 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_48 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_2_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_49 = _GEN_45 ? sectored_entries_0_2_valid_0 : ~invalidate_refill & (_GEN_46 | r_sectored_hit_valid & sectored_entries_0_2_valid_0);
  wire        _GEN_50 = _GEN_45 ? sectored_entries_0_2_valid_1 : ~invalidate_refill & (_GEN_47 | r_sectored_hit_valid & sectored_entries_0_2_valid_1);
  wire        _GEN_51 = _GEN_45 ? sectored_entries_0_2_valid_2 : ~invalidate_refill & (_GEN_48 | r_sectored_hit_valid & sectored_entries_0_2_valid_2);
  wire        _GEN_52 = _GEN_45 ? sectored_entries_0_2_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_2_valid_3);
  wire        _GEN_53 = waddr_1 == 3'h3;
  wire        _GEN_54 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_53;
  wire        _GEN_55 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_56 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_57 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_3_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_58 = _GEN_54 ? sectored_entries_0_3_valid_0 : ~invalidate_refill & (_GEN_55 | r_sectored_hit_valid & sectored_entries_0_3_valid_0);
  wire        _GEN_59 = _GEN_54 ? sectored_entries_0_3_valid_1 : ~invalidate_refill & (_GEN_56 | r_sectored_hit_valid & sectored_entries_0_3_valid_1);
  wire        _GEN_60 = _GEN_54 ? sectored_entries_0_3_valid_2 : ~invalidate_refill & (_GEN_57 | r_sectored_hit_valid & sectored_entries_0_3_valid_2);
  wire        _GEN_61 = _GEN_54 ? sectored_entries_0_3_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_3_valid_3);
  wire        _GEN_62 = waddr_1 == 3'h4;
  wire        _GEN_63 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_62;
  wire        _GEN_64 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_65 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_66 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_4_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_67 = _GEN_63 ? sectored_entries_0_4_valid_0 : ~invalidate_refill & (_GEN_64 | r_sectored_hit_valid & sectored_entries_0_4_valid_0);
  wire        _GEN_68 = _GEN_63 ? sectored_entries_0_4_valid_1 : ~invalidate_refill & (_GEN_65 | r_sectored_hit_valid & sectored_entries_0_4_valid_1);
  wire        _GEN_69 = _GEN_63 ? sectored_entries_0_4_valid_2 : ~invalidate_refill & (_GEN_66 | r_sectored_hit_valid & sectored_entries_0_4_valid_2);
  wire        _GEN_70 = _GEN_63 ? sectored_entries_0_4_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_4_valid_3);
  wire        _GEN_71 = waddr_1 == 3'h5;
  wire        _GEN_72 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_71;
  wire        _GEN_73 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_74 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_75 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_5_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_76 = _GEN_72 ? sectored_entries_0_5_valid_0 : ~invalidate_refill & (_GEN_73 | r_sectored_hit_valid & sectored_entries_0_5_valid_0);
  wire        _GEN_77 = _GEN_72 ? sectored_entries_0_5_valid_1 : ~invalidate_refill & (_GEN_74 | r_sectored_hit_valid & sectored_entries_0_5_valid_1);
  wire        _GEN_78 = _GEN_72 ? sectored_entries_0_5_valid_2 : ~invalidate_refill & (_GEN_75 | r_sectored_hit_valid & sectored_entries_0_5_valid_2);
  wire        _GEN_79 = _GEN_72 ? sectored_entries_0_5_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_5_valid_3);
  wire        _GEN_80 = waddr_1 == 3'h6;
  wire        _GEN_81 = ~io_ptw_resp_valid | _GEN_26 | ~_GEN_80;
  wire        _GEN_82 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_83 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_84 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_6_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_85 = _GEN_81 ? sectored_entries_0_6_valid_0 : ~invalidate_refill & (_GEN_82 | r_sectored_hit_valid & sectored_entries_0_6_valid_0);
  wire        _GEN_86 = _GEN_81 ? sectored_entries_0_6_valid_1 : ~invalidate_refill & (_GEN_83 | r_sectored_hit_valid & sectored_entries_0_6_valid_1);
  wire        _GEN_87 = _GEN_81 ? sectored_entries_0_6_valid_2 : ~invalidate_refill & (_GEN_84 | r_sectored_hit_valid & sectored_entries_0_6_valid_2);
  wire        _GEN_88 = _GEN_81 ? sectored_entries_0_6_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_6_valid_3);
  wire        _GEN_89 = ~io_ptw_resp_valid | _GEN_26 | ~(&waddr_1);
  wire        _GEN_90 = r_refill_tag[1:0] == 2'h0;
  wire        _GEN_91 = r_refill_tag[1:0] == 2'h1;
  wire        _GEN_92 = r_refill_tag[1:0] == 2'h2;
  wire [42:0] _sectored_entries_0_7_data_T = {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
  wire        _GEN_93 = _GEN_89 ? sectored_entries_0_7_valid_0 : ~invalidate_refill & (_GEN_90 | r_sectored_hit_valid & sectored_entries_0_7_valid_0);
  wire        _GEN_94 = _GEN_89 ? sectored_entries_0_7_valid_1 : ~invalidate_refill & (_GEN_91 | r_sectored_hit_valid & sectored_entries_0_7_valid_1);
  wire        _GEN_95 = _GEN_89 ? sectored_entries_0_7_valid_2 : ~invalidate_refill & (_GEN_92 | r_sectored_hit_valid & sectored_entries_0_7_valid_2);
  wire        _GEN_96 = _GEN_89 ? sectored_entries_0_7_valid_3 : ~invalidate_refill & ((&(r_refill_tag[1:0])) | r_sectored_hit_valid & sectored_entries_0_7_valid_3);
  wire [2:0]  _GEN_97 = {sector_hits_7, sector_hits_6, sector_hits_5};
  wire [2:0]  _GEN_98 = {sector_hits_3, sector_hits_2, sector_hits_1};
  wire        _GEN_99 = state == 2'h0 & io_req_valid & tlb_miss;
  wire [24:0] _GEN_100 = sectored_entries_0_0_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_101 = _GEN_100 == 25'h0 & ~sectored_entries_0_0_tag_v;
  wire        _GEN_102 = io_req_bits_vaddr[13:12] == 2'h0;
  wire        _GEN_103 = _GEN_101 & ~sectored_entries_0_0_tag_v & _GEN_102;
  wire        _GEN_104 = io_req_bits_vaddr[13:12] == 2'h1;
  wire        _GEN_105 = _GEN_101 & ~sectored_entries_0_0_tag_v & _GEN_104;
  wire        _GEN_106 = io_req_bits_vaddr[13:12] == 2'h2;
  wire        _GEN_107 = _GEN_101 & ~sectored_entries_0_0_tag_v & _GEN_106;
  wire        _GEN_108 = _GEN_101 & ~sectored_entries_0_0_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_109 = _GEN_100[24:16] == 9'h0;
  wire [24:0] _GEN_110 = sectored_entries_0_1_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_111 = _GEN_110 == 25'h0 & ~sectored_entries_0_1_tag_v;
  wire        _GEN_112 = _GEN_111 & ~sectored_entries_0_1_tag_v & _GEN_102;
  wire        _GEN_113 = _GEN_111 & ~sectored_entries_0_1_tag_v & _GEN_104;
  wire        _GEN_114 = _GEN_111 & ~sectored_entries_0_1_tag_v & _GEN_106;
  wire        _GEN_115 = _GEN_111 & ~sectored_entries_0_1_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_116 = _GEN_110[24:16] == 9'h0;
  wire [24:0] _GEN_117 = sectored_entries_0_2_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_118 = _GEN_117 == 25'h0 & ~sectored_entries_0_2_tag_v;
  wire        _GEN_119 = _GEN_118 & ~sectored_entries_0_2_tag_v & _GEN_102;
  wire        _GEN_120 = _GEN_118 & ~sectored_entries_0_2_tag_v & _GEN_104;
  wire        _GEN_121 = _GEN_118 & ~sectored_entries_0_2_tag_v & _GEN_106;
  wire        _GEN_122 = _GEN_118 & ~sectored_entries_0_2_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_123 = _GEN_117[24:16] == 9'h0;
  wire [24:0] _GEN_124 = sectored_entries_0_3_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_125 = _GEN_124 == 25'h0 & ~sectored_entries_0_3_tag_v;
  wire        _GEN_126 = _GEN_125 & ~sectored_entries_0_3_tag_v & _GEN_102;
  wire        _GEN_127 = _GEN_125 & ~sectored_entries_0_3_tag_v & _GEN_104;
  wire        _GEN_128 = _GEN_125 & ~sectored_entries_0_3_tag_v & _GEN_106;
  wire        _GEN_129 = _GEN_125 & ~sectored_entries_0_3_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_130 = _GEN_124[24:16] == 9'h0;
  wire [24:0] _GEN_131 = sectored_entries_0_4_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_132 = _GEN_131 == 25'h0 & ~sectored_entries_0_4_tag_v;
  wire        _GEN_133 = _GEN_132 & ~sectored_entries_0_4_tag_v & _GEN_102;
  wire        _GEN_134 = _GEN_132 & ~sectored_entries_0_4_tag_v & _GEN_104;
  wire        _GEN_135 = _GEN_132 & ~sectored_entries_0_4_tag_v & _GEN_106;
  wire        _GEN_136 = _GEN_132 & ~sectored_entries_0_4_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_137 = _GEN_131[24:16] == 9'h0;
  wire [24:0] _GEN_138 = sectored_entries_0_5_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_139 = _GEN_138 == 25'h0 & ~sectored_entries_0_5_tag_v;
  wire        _GEN_140 = _GEN_139 & ~sectored_entries_0_5_tag_v & _GEN_102;
  wire        _GEN_141 = _GEN_139 & ~sectored_entries_0_5_tag_v & _GEN_104;
  wire        _GEN_142 = _GEN_139 & ~sectored_entries_0_5_tag_v & _GEN_106;
  wire        _GEN_143 = _GEN_139 & ~sectored_entries_0_5_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_144 = _GEN_138[24:16] == 9'h0;
  wire [24:0] _GEN_145 = sectored_entries_0_6_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_146 = _GEN_145 == 25'h0 & ~sectored_entries_0_6_tag_v;
  wire        _GEN_147 = _GEN_146 & ~sectored_entries_0_6_tag_v & _GEN_102;
  wire        _GEN_148 = _GEN_146 & ~sectored_entries_0_6_tag_v & _GEN_104;
  wire        _GEN_149 = _GEN_146 & ~sectored_entries_0_6_tag_v & _GEN_106;
  wire        _GEN_150 = _GEN_146 & ~sectored_entries_0_6_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_151 = _GEN_145[24:16] == 9'h0;
  wire [24:0] _GEN_152 = sectored_entries_0_7_tag_vpn[26:2] ^ io_req_bits_vaddr[38:14];
  wire        _GEN_153 = _GEN_152 == 25'h0 & ~sectored_entries_0_7_tag_v;
  wire        _GEN_154 = _GEN_153 & ~sectored_entries_0_7_tag_v & _GEN_102;
  wire        _GEN_155 = _GEN_153 & ~sectored_entries_0_7_tag_v & _GEN_104;
  wire        _GEN_156 = _GEN_153 & ~sectored_entries_0_7_tag_v & _GEN_106;
  wire        _GEN_157 = _GEN_153 & ~sectored_entries_0_7_tag_v & (&(io_req_bits_vaddr[13:12]));
  wire        _GEN_158 = _GEN_152[24:16] == 9'h0;
  wire        _GEN_159 = _hitsVec_T_58[17:9] == 9'h0;
  wire        _GEN_160 = superpage_entries_0_valid_0 & ~superpage_entries_0_tag_v & _GEN_159 & (ignore_1 | _hitsVec_T_58[8:0] == 9'h0);
  wire        _GEN_161 = _hitsVec_T_73[17:9] == 9'h0;
  wire        _GEN_162 = superpage_entries_1_valid_0 & ~superpage_entries_1_tag_v & _GEN_161 & (ignore_4 | _hitsVec_T_73[8:0] == 9'h0);
  wire        _GEN_163 = _hitsVec_T_88[17:9] == 9'h0;
  wire        _GEN_164 = superpage_entries_2_valid_0 & ~superpage_entries_2_tag_v & _GEN_163 & (ignore_7 | _hitsVec_T_88[8:0] == 9'h0);
  wire        _GEN_165 = _hitsVec_T_103[17:9] == 9'h0;
  wire        _GEN_166 = superpage_entries_3_valid_0 & ~superpage_entries_3_tag_v & _GEN_165 & (ignore_10 | _hitsVec_T_103[8:0] == 9'h0);
  wire        _GEN_167 = _hitsVec_T_118[26:18] == 9'h0;
  wire        _GEN_168 = special_entry_valid_0 & _GEN_167 & (ignore_13 | _hitsVec_T_118[17:9] == 9'h0) & (~(special_entry_level[1]) | _hitsVec_T_118[8:0] == 9'h0);
  wire        _GEN_169 = multipleHits | reset;
  ...
  wire [2:0]  _r_sectored_hit_bits_T_2 = _GEN_97 | _GEN_98;
  wire [3:0]  hi_1 = {sector_hits_7, sector_hits_6, sector_hits_5, sector_hits_4};
  wire [2:0]  _GEN_170 = _GEN_97 | _GEN_98;
  wire        _state_vec_0_T_6 = _GEN_170[2] | _GEN_170[0];
  always @(posedge clock) begin
    if (_GEN_27) begin
    end
    else
      sectored_entries_0_0_tag_vpn <= r_refill_tag;
    sectored_entries_0_0_tag_v <= _GEN_27 & sectored_entries_0_0_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_25 & _GEN_28)) begin
    end
    else
      sectored_entries_0_0_data_0 <= _sectored_entries_0_0_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_25 & _GEN_29)) begin
    end
    else
      sectored_entries_0_0_data_1 <= _sectored_entries_0_0_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_25 & _GEN_30)) begin
    end
    else
      sectored_entries_0_0_data_2 <= _sectored_entries_0_0_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_25 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_0_data_3 <= _sectored_entries_0_0_data_T;
    sectored_entries_0_0_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_109 ? ~(~sectored_entries_0_0_tag_v & sectored_entries_0_0_data_0[0] | _GEN_103) & _GEN_31 : ~_GEN_103 & _GEN_31) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_0_tag_v & ~(sectored_entries_0_0_data_0[20])) & _GEN_31 : sectored_entries_0_0_tag_v & _GEN_31) : _GEN_31);
    sectored_entries_0_0_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_109 ? ~(~sectored_entries_0_0_tag_v & sectored_entries_0_0_data_1[0] | _GEN_105) & _GEN_32 : ~_GEN_105 & _GEN_32) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_0_tag_v & ~(sectored_entries_0_0_data_1[20])) & _GEN_32 : sectored_entries_0_0_tag_v & _GEN_32) : _GEN_32);
    sectored_entries_0_0_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_109 ? ~(~sectored_entries_0_0_tag_v & sectored_entries_0_0_data_2[0] | _GEN_107) & _GEN_33 : ~_GEN_107 & _GEN_33) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_0_tag_v & ~(sectored_entries_0_0_data_2[20])) & _GEN_33 : sectored_entries_0_0_tag_v & _GEN_33) : _GEN_33);
    sectored_entries_0_0_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_109 ? ~(~sectored_entries_0_0_tag_v & sectored_entries_0_0_data_3[0] | _GEN_108) & _GEN_34 : ~_GEN_108 & _GEN_34) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_0_tag_v & ~(sectored_entries_0_0_data_3[20])) & _GEN_34 : sectored_entries_0_0_tag_v & _GEN_34) : _GEN_34);
    if (_GEN_36) begin
    end
    else
      sectored_entries_0_1_tag_vpn <= r_refill_tag;
    sectored_entries_0_1_tag_v <= _GEN_36 & sectored_entries_0_1_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_35 & _GEN_37)) begin
    end
    else
      sectored_entries_0_1_data_0 <= _sectored_entries_0_1_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_35 & _GEN_38)) begin
    end
    else
      sectored_entries_0_1_data_1 <= _sectored_entries_0_1_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_35 & _GEN_39)) begin
    end
    else
      sectored_entries_0_1_data_2 <= _sectored_entries_0_1_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_35 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_1_data_3 <= _sectored_entries_0_1_data_T;
    sectored_entries_0_1_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_116 ? ~(~sectored_entries_0_1_tag_v & sectored_entries_0_1_data_0[0] | _GEN_112) & _GEN_40 : ~_GEN_112 & _GEN_40) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_1_tag_v & ~(sectored_entries_0_1_data_0[20])) & _GEN_40 : sectored_entries_0_1_tag_v & _GEN_40) : _GEN_40);
    sectored_entries_0_1_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_116 ? ~(~sectored_entries_0_1_tag_v & sectored_entries_0_1_data_1[0] | _GEN_113) & _GEN_41 : ~_GEN_113 & _GEN_41) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_1_tag_v & ~(sectored_entries_0_1_data_1[20])) & _GEN_41 : sectored_entries_0_1_tag_v & _GEN_41) : _GEN_41);
    sectored_entries_0_1_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_116 ? ~(~sectored_entries_0_1_tag_v & sectored_entries_0_1_data_2[0] | _GEN_114) & _GEN_42 : ~_GEN_114 & _GEN_42) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_1_tag_v & ~(sectored_entries_0_1_data_2[20])) & _GEN_42 : sectored_entries_0_1_tag_v & _GEN_42) : _GEN_42);
    sectored_entries_0_1_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_116 ? ~(~sectored_entries_0_1_tag_v & sectored_entries_0_1_data_3[0] | _GEN_115) & _GEN_43 : ~_GEN_115 & _GEN_43) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_1_tag_v & ~(sectored_entries_0_1_data_3[20])) & _GEN_43 : sectored_entries_0_1_tag_v & _GEN_43) : _GEN_43);
    if (_GEN_45) begin
    end
    else
      sectored_entries_0_2_tag_vpn <= r_refill_tag;
    sectored_entries_0_2_tag_v <= _GEN_45 & sectored_entries_0_2_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_44 & _GEN_46)) begin
    end
    else
      sectored_entries_0_2_data_0 <= _sectored_entries_0_2_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_44 & _GEN_47)) begin
    end
    else
      sectored_entries_0_2_data_1 <= _sectored_entries_0_2_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_44 & _GEN_48)) begin
    end
    else
      sectored_entries_0_2_data_2 <= _sectored_entries_0_2_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_44 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_2_data_3 <= _sectored_entries_0_2_data_T;
    sectored_entries_0_2_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_123 ? ~(~sectored_entries_0_2_tag_v & sectored_entries_0_2_data_0[0] | _GEN_119) & _GEN_49 : ~_GEN_119 & _GEN_49) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_2_tag_v & ~(sectored_entries_0_2_data_0[20])) & _GEN_49 : sectored_entries_0_2_tag_v & _GEN_49) : _GEN_49);
    sectored_entries_0_2_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_123 ? ~(~sectored_entries_0_2_tag_v & sectored_entries_0_2_data_1[0] | _GEN_120) & _GEN_50 : ~_GEN_120 & _GEN_50) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_2_tag_v & ~(sectored_entries_0_2_data_1[20])) & _GEN_50 : sectored_entries_0_2_tag_v & _GEN_50) : _GEN_50);
    sectored_entries_0_2_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_123 ? ~(~sectored_entries_0_2_tag_v & sectored_entries_0_2_data_2[0] | _GEN_121) & _GEN_51 : ~_GEN_121 & _GEN_51) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_2_tag_v & ~(sectored_entries_0_2_data_2[20])) & _GEN_51 : sectored_entries_0_2_tag_v & _GEN_51) : _GEN_51);
    sectored_entries_0_2_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_123 ? ~(~sectored_entries_0_2_tag_v & sectored_entries_0_2_data_3[0] | _GEN_122) & _GEN_52 : ~_GEN_122 & _GEN_52) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_2_tag_v & ~(sectored_entries_0_2_data_3[20])) & _GEN_52 : sectored_entries_0_2_tag_v & _GEN_52) : _GEN_52);
    if (_GEN_54) begin
    end
    else
      sectored_entries_0_3_tag_vpn <= r_refill_tag;
    sectored_entries_0_3_tag_v <= _GEN_54 & sectored_entries_0_3_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_53 & _GEN_55)) begin
    end
    else
      sectored_entries_0_3_data_0 <= _sectored_entries_0_3_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_53 & _GEN_56)) begin
    end
    else
      sectored_entries_0_3_data_1 <= _sectored_entries_0_3_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_53 & _GEN_57)) begin
    end
    else
      sectored_entries_0_3_data_2 <= _sectored_entries_0_3_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_53 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_3_data_3 <= _sectored_entries_0_3_data_T;
    sectored_entries_0_3_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_130 ? ~(~sectored_entries_0_3_tag_v & sectored_entries_0_3_data_0[0] | _GEN_126) & _GEN_58 : ~_GEN_126 & _GEN_58) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_3_tag_v & ~(sectored_entries_0_3_data_0[20])) & _GEN_58 : sectored_entries_0_3_tag_v & _GEN_58) : _GEN_58);
    sectored_entries_0_3_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_130 ? ~(~sectored_entries_0_3_tag_v & sectored_entries_0_3_data_1[0] | _GEN_127) & _GEN_59 : ~_GEN_127 & _GEN_59) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_3_tag_v & ~(sectored_entries_0_3_data_1[20])) & _GEN_59 : sectored_entries_0_3_tag_v & _GEN_59) : _GEN_59);
    sectored_entries_0_3_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_130 ? ~(~sectored_entries_0_3_tag_v & sectored_entries_0_3_data_2[0] | _GEN_128) & _GEN_60 : ~_GEN_128 & _GEN_60) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_3_tag_v & ~(sectored_entries_0_3_data_2[20])) & _GEN_60 : sectored_entries_0_3_tag_v & _GEN_60) : _GEN_60);
    sectored_entries_0_3_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_130 ? ~(~sectored_entries_0_3_tag_v & sectored_entries_0_3_data_3[0] | _GEN_129) & _GEN_61 : ~_GEN_129 & _GEN_61) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_3_tag_v & ~(sectored_entries_0_3_data_3[20])) & _GEN_61 : sectored_entries_0_3_tag_v & _GEN_61) : _GEN_61);
    if (_GEN_63) begin
    end
    else
      sectored_entries_0_4_tag_vpn <= r_refill_tag;
    sectored_entries_0_4_tag_v <= _GEN_63 & sectored_entries_0_4_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_62 & _GEN_64)) begin
    end
    else
      sectored_entries_0_4_data_0 <= _sectored_entries_0_4_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_62 & _GEN_65)) begin
    end
    else
      sectored_entries_0_4_data_1 <= _sectored_entries_0_4_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_62 & _GEN_66)) begin
    end
    else
      sectored_entries_0_4_data_2 <= _sectored_entries_0_4_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_62 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_4_data_3 <= _sectored_entries_0_4_data_T;
    sectored_entries_0_4_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_137 ? ~(~sectored_entries_0_4_tag_v & sectored_entries_0_4_data_0[0] | _GEN_133) & _GEN_67 : ~_GEN_133 & _GEN_67) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_4_tag_v & ~(sectored_entries_0_4_data_0[20])) & _GEN_67 : sectored_entries_0_4_tag_v & _GEN_67) : _GEN_67);
    sectored_entries_0_4_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_137 ? ~(~sectored_entries_0_4_tag_v & sectored_entries_0_4_data_1[0] | _GEN_134) & _GEN_68 : ~_GEN_134 & _GEN_68) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_4_tag_v & ~(sectored_entries_0_4_data_1[20])) & _GEN_68 : sectored_entries_0_4_tag_v & _GEN_68) : _GEN_68);
    sectored_entries_0_4_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_137 ? ~(~sectored_entries_0_4_tag_v & sectored_entries_0_4_data_2[0] | _GEN_135) & _GEN_69 : ~_GEN_135 & _GEN_69) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_4_tag_v & ~(sectored_entries_0_4_data_2[20])) & _GEN_69 : sectored_entries_0_4_tag_v & _GEN_69) : _GEN_69);
    sectored_entries_0_4_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_137 ? ~(~sectored_entries_0_4_tag_v & sectored_entries_0_4_data_3[0] | _GEN_136) & _GEN_70 : ~_GEN_136 & _GEN_70) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_4_tag_v & ~(sectored_entries_0_4_data_3[20])) & _GEN_70 : sectored_entries_0_4_tag_v & _GEN_70) : _GEN_70);
    if (_GEN_72) begin
    end
    else
      sectored_entries_0_5_tag_vpn <= r_refill_tag;
    sectored_entries_0_5_tag_v <= _GEN_72 & sectored_entries_0_5_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_71 & _GEN_73)) begin
    end
    else
      sectored_entries_0_5_data_0 <= _sectored_entries_0_5_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_71 & _GEN_74)) begin
    end
    else
      sectored_entries_0_5_data_1 <= _sectored_entries_0_5_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_71 & _GEN_75)) begin
    end
    else
      sectored_entries_0_5_data_2 <= _sectored_entries_0_5_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_71 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_5_data_3 <= _sectored_entries_0_5_data_T;
    sectored_entries_0_5_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_144 ? ~(~sectored_entries_0_5_tag_v & sectored_entries_0_5_data_0[0] | _GEN_140) & _GEN_76 : ~_GEN_140 & _GEN_76) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_5_tag_v & ~(sectored_entries_0_5_data_0[20])) & _GEN_76 : sectored_entries_0_5_tag_v & _GEN_76) : _GEN_76);
    sectored_entries_0_5_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_144 ? ~(~sectored_entries_0_5_tag_v & sectored_entries_0_5_data_1[0] | _GEN_141) & _GEN_77 : ~_GEN_141 & _GEN_77) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_5_tag_v & ~(sectored_entries_0_5_data_1[20])) & _GEN_77 : sectored_entries_0_5_tag_v & _GEN_77) : _GEN_77);
    sectored_entries_0_5_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_144 ? ~(~sectored_entries_0_5_tag_v & sectored_entries_0_5_data_2[0] | _GEN_142) & _GEN_78 : ~_GEN_142 & _GEN_78) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_5_tag_v & ~(sectored_entries_0_5_data_2[20])) & _GEN_78 : sectored_entries_0_5_tag_v & _GEN_78) : _GEN_78);
    sectored_entries_0_5_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_144 ? ~(~sectored_entries_0_5_tag_v & sectored_entries_0_5_data_3[0] | _GEN_143) & _GEN_79 : ~_GEN_143 & _GEN_79) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_5_tag_v & ~(sectored_entries_0_5_data_3[20])) & _GEN_79 : sectored_entries_0_5_tag_v & _GEN_79) : _GEN_79);
    if (_GEN_81) begin
    end
    else
      sectored_entries_0_6_tag_vpn <= r_refill_tag;
    sectored_entries_0_6_tag_v <= _GEN_81 & sectored_entries_0_6_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_80 & _GEN_82)) begin
    end
    else
      sectored_entries_0_6_data_0 <= _sectored_entries_0_6_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_80 & _GEN_83)) begin
    end
    else
      sectored_entries_0_6_data_1 <= _sectored_entries_0_6_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_80 & _GEN_84)) begin
    end
    else
      sectored_entries_0_6_data_2 <= _sectored_entries_0_6_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~(_GEN_80 & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_6_data_3 <= _sectored_entries_0_6_data_T;
    sectored_entries_0_6_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_151 ? ~(~sectored_entries_0_6_tag_v & sectored_entries_0_6_data_0[0] | _GEN_147) & _GEN_85 : ~_GEN_147 & _GEN_85) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_6_tag_v & ~(sectored_entries_0_6_data_0[20])) & _GEN_85 : sectored_entries_0_6_tag_v & _GEN_85) : _GEN_85);
    sectored_entries_0_6_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_151 ? ~(~sectored_entries_0_6_tag_v & sectored_entries_0_6_data_1[0] | _GEN_148) & _GEN_86 : ~_GEN_148 & _GEN_86) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_6_tag_v & ~(sectored_entries_0_6_data_1[20])) & _GEN_86 : sectored_entries_0_6_tag_v & _GEN_86) : _GEN_86);
    sectored_entries_0_6_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_151 ? ~(~sectored_entries_0_6_tag_v & sectored_entries_0_6_data_2[0] | _GEN_149) & _GEN_87 : ~_GEN_149 & _GEN_87) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_6_tag_v & ~(sectored_entries_0_6_data_2[20])) & _GEN_87 : sectored_entries_0_6_tag_v & _GEN_87) : _GEN_87);
    sectored_entries_0_6_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_151 ? ~(~sectored_entries_0_6_tag_v & sectored_entries_0_6_data_3[0] | _GEN_150) & _GEN_88 : ~_GEN_150 & _GEN_88) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_6_tag_v & ~(sectored_entries_0_6_data_3[20])) & _GEN_88 : sectored_entries_0_6_tag_v & _GEN_88) : _GEN_88);
    if (_GEN_89) begin
    end
    else
      sectored_entries_0_7_tag_vpn <= r_refill_tag;
    sectored_entries_0_7_tag_v <= _GEN_89 & sectored_entries_0_7_tag_v;
    if (~io_ptw_resp_valid | _GEN_26 | ~((&waddr_1) & _GEN_90)) begin
    end
    else
      sectored_entries_0_7_data_0 <= _sectored_entries_0_7_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~((&waddr_1) & _GEN_91)) begin
    end
    else
      sectored_entries_0_7_data_1 <= _sectored_entries_0_7_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~((&waddr_1) & _GEN_92)) begin
    end
    else
      sectored_entries_0_7_data_2 <= _sectored_entries_0_7_data_T;
    if (~io_ptw_resp_valid | _GEN_26 | ~((&waddr_1) & (&(r_refill_tag[1:0])))) begin
    end
    else
      sectored_entries_0_7_data_3 <= _sectored_entries_0_7_data_T;
    sectored_entries_0_7_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_158 ? ~(~sectored_entries_0_7_tag_v & sectored_entries_0_7_data_0[0] | _GEN_154) & _GEN_93 : ~_GEN_154 & _GEN_93) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_7_tag_v & ~(sectored_entries_0_7_data_0[20])) & _GEN_93 : sectored_entries_0_7_tag_v & _GEN_93) : _GEN_93);
    sectored_entries_0_7_valid_1 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_158 ? ~(~sectored_entries_0_7_tag_v & sectored_entries_0_7_data_1[0] | _GEN_155) & _GEN_94 : ~_GEN_155 & _GEN_94) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_7_tag_v & ~(sectored_entries_0_7_data_1[20])) & _GEN_94 : sectored_entries_0_7_tag_v & _GEN_94) : _GEN_94);
    sectored_entries_0_7_valid_2 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_158 ? ~(~sectored_entries_0_7_tag_v & sectored_entries_0_7_data_2[0] | _GEN_156) & _GEN_95 : ~_GEN_156 & _GEN_95) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_7_tag_v & ~(sectored_entries_0_7_data_2[20])) & _GEN_95 : sectored_entries_0_7_tag_v & _GEN_95) : _GEN_95);
    sectored_entries_0_7_valid_3 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_158 ? ~(~sectored_entries_0_7_tag_v & sectored_entries_0_7_data_3[0] | _GEN_157) & _GEN_96 : ~_GEN_157 & _GEN_96) : io_sfence_bits_rs2 ? ~(~sectored_entries_0_7_tag_v & ~(sectored_entries_0_7_data_3[20])) & _GEN_96 : sectored_entries_0_7_tag_v & _GEN_96) : _GEN_96);
    if (_GEN_14) begin
      superpage_entries_0_level <= {1'h0, io_ptw_resp_bits_level[0]};
      superpage_entries_0_tag_vpn <= r_refill_tag;
    end
    superpage_entries_0_tag_v <= (~io_ptw_resp_valid | ~io_ptw_resp_bits_homogeneous | ~_GEN_13) & superpage_entries_0_tag_v;
    if (_GEN_14)
      superpage_entries_0_data_0 <= {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
    superpage_entries_0_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_159 ? ~(~superpage_entries_0_tag_v & superpage_entries_0_data_0[0] | _GEN_160) & _GEN_15 : ~_GEN_160 & _GEN_15) : io_sfence_bits_rs2 ? ~(~superpage_entries_0_tag_v & ~(superpage_entries_0_data_0[20])) & _GEN_15 : superpage_entries_0_tag_v & _GEN_15) : _GEN_15);
    if (_GEN_17) begin
      superpage_entries_1_level <= {1'h0, io_ptw_resp_bits_level[0]};
      superpage_entries_1_tag_vpn <= r_refill_tag;
    end
    superpage_entries_1_tag_v <= (~io_ptw_resp_valid | ~io_ptw_resp_bits_homogeneous | ~_GEN_16) & superpage_entries_1_tag_v;
    if (_GEN_17)
      superpage_entries_1_data_0 <= {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
    superpage_entries_1_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_161 ? ~(~superpage_entries_1_tag_v & superpage_entries_1_data_0[0] | _GEN_162) & _GEN_18 : ~_GEN_162 & _GEN_18) : io_sfence_bits_rs2 ? ~(~superpage_entries_1_tag_v & ~(superpage_entries_1_data_0[20])) & _GEN_18 : superpage_entries_1_tag_v & _GEN_18) : _GEN_18);
    if (_GEN_20) begin
      superpage_entries_2_level <= {1'h0, io_ptw_resp_bits_level[0]};
      superpage_entries_2_tag_vpn <= r_refill_tag;
    end
    superpage_entries_2_tag_v <= (~io_ptw_resp_valid | ~io_ptw_resp_bits_homogeneous | ~_GEN_19) & superpage_entries_2_tag_v;
    if (_GEN_20)
      superpage_entries_2_data_0 <= {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
    superpage_entries_2_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_163 ? ~(~superpage_entries_2_tag_v & superpage_entries_2_data_0[0] | _GEN_164) & _GEN_21 : ~_GEN_164 & _GEN_21) : io_sfence_bits_rs2 ? ~(~superpage_entries_2_tag_v & ~(superpage_entries_2_data_0[20])) & _GEN_21 : superpage_entries_2_tag_v & _GEN_21) : _GEN_21);
    if (_GEN_23) begin
      superpage_entries_3_level <= {1'h0, io_ptw_resp_bits_level[0]};
      superpage_entries_3_tag_vpn <= r_refill_tag;
    end
    superpage_entries_3_tag_v <= (~io_ptw_resp_valid | ~io_ptw_resp_bits_homogeneous | ~_GEN_22) & superpage_entries_3_tag_v;
    if (_GEN_23)
      superpage_entries_3_data_0 <= {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
    superpage_entries_3_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_165 ? ~(~superpage_entries_3_tag_v & superpage_entries_3_data_0[0] | _GEN_166) & _GEN_24 : ~_GEN_166 & _GEN_24) : io_sfence_bits_rs2 ? ~(~superpage_entries_3_tag_v & ~(superpage_entries_3_data_0[20])) & _GEN_24 : superpage_entries_3_tag_v & _GEN_24) : _GEN_24);
    if (_GEN_11) begin
      special_entry_level <= io_ptw_resp_bits_level;
      special_entry_tag_vpn <= r_refill_tag;
      special_entry_data_0 <= {io_ptw_resp_bits_pte_ppn[20:0], io_ptw_resp_bits_pte_u, newEntry_g, io_ptw_resp_bits_ae_ptw, io_ptw_resp_bits_ae_final, 1'h0, io_ptw_resp_bits_pf, io_ptw_resp_bits_gf, newEntry_sw, newEntry_sx, newEntry_sr, io_ptw_resp_bits_hw, io_ptw_resp_bits_hx, io_ptw_resp_bits_hr, newEntry_pw, newEntry_px, newEntry_pr, newEntry_ppp, newEntry_pal, newEntry_paa, newEntry_eff, newEntry_c, 1'h0};
    end
    special_entry_valid_0 <= ~_GEN_169 & (io_sfence_valid ? (io_sfence_bits_rs1 ? (_GEN_167 ? ~(special_entry_data_0[0] | _GEN_168) & _GEN_12 : ~_GEN_168 & _GEN_12) : io_sfence_bits_rs2 & special_entry_data_0[20] & _GEN_12) : _GEN_12);
    if (_GEN_99) begin
    ...
    if (reset) begin
      ...
      if (_GEN_5 & (sector_hits_0 | sector_hits_1 | sector_hits_2 | sector_hits_3 | sector_hits_4 | sector_hits_5 | sector_hits_6 | sector_hits_7))
        state_vec_0 <= {~(|hi_1), (|hi_1) ? {~(|(_GEN_170[2:1])), (|(_GEN_170[2:1])) ? ~_state_vec_0_T_6 : state_vec_0[4], (|(_GEN_170[2:1])) ? state_vec_0[3] : ~_state_vec_0_T_6} : state_vec_0[5:3], (|hi_1) ? state_vec_0[2:0] : {~(|(_GEN_170[2:1])), (|(_GEN_170[2:1])) ? ~_state_vec_0_T_6 : state_vec_0[1], (|(_GEN_170[2:1])) ? state_vec_0[0] : ~_state_vec_0_T_6}};
