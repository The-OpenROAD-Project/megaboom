...
module TLMonitor_1(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _GEN_61 = io_in_b_valid & ~reset;
    ...
    wire [20:0]  _GEN_63 = {io_in_c_bits_address[32:14], ~(io_in_c_bits_address[13:12])};
    wire [20:0]  _GEN_64 = {io_in_c_bits_address[32:26], io_in_c_bits_address[25:12] ^ 14'h2010};
    wire [6:0]   _GEN_65 = {io_in_c_bits_address[32:28], ~(io_in_c_bits_address[27:26])};
    wire [16:0]  _GEN_66 = {io_in_c_bits_address[32:26], io_in_c_bits_address[25:16] ^ 10'h200};
    wire [16:0]  _GEN_67 = {io_in_c_bits_address[32:17], ~(io_in_c_bits_address[16])};
    wire [8:0]   _GEN_68 = io_in_c_bits_address[20:12] ^ 9'h100;
    wire [1:0]   _GEN_69 = {io_in_c_bits_address[32], ~(io_in_c_bits_address[31])};
    wire         _GEN_70 = io_in_c_bits_address[32:31] != 2'h2;
    wire [16:0]  _GEN_71 = {io_in_c_bits_address[32:28], io_in_c_bits_address[27:16] ^ 12'h800};
    wire         address_ok_1 = ~(|_GEN_63) | ~(|_GEN_64) | {io_in_c_bits_address[32:13], ~(io_in_c_bits_address[12])} == 21'h0 | ~(|_GEN_65) | ~(|_GEN_66) | io_in_c_bits_address[32:12] == 21'h0 | ~(|_GEN_67) | {io_in_c_bits_address[32:21], _GEN_68} == 21'h0 | {io_in_c_bits_address[32:21], io_in_c_bits_address[20:12] ^ 9'h110} == 21'h0 | ~(|_GEN_69) | ~_GEN_70 | ~(|_GEN_71);
    wire         _GEN_72 = io_in_c_valid & io_in_c_bits_opcode == 3'h4 & ~reset;
    wire         _GEN_73 = io_in_c_bits_size < 4'h3;
    wire         _GEN_74 = io_in_c_valid & io_in_c_bits_opcode == 3'h5 & ~reset;
    wire         _GEN_75 = io_in_c_bits_size < 4'hD;
    wire         _GEN_76 = io_in_c_bits_size == 4'h6;
    wire         _GEN_77 = _GEN_76 & (~(|_GEN_71) | ~(|_GEN_69) | ~_GEN_70);
    wire         _GEN_78 = io_in_c_valid & io_in_c_bits_opcode == 3'h6 & ~reset;
    wire         _GEN_79 = _GEN_75 & (io_in_c_bits_address[32:13] == 20'h0 | ~(|_GEN_63) | ~(|_GEN_67) | {io_in_c_bits_address[32:21], _GEN_68[8:5], io_in_c_bits_address[15:12]} == 20'h0 | ~(|_GEN_66) | ~(|_GEN_64) | ~(|_GEN_71) | ~(|_GEN_65) | ~(|_GEN_69) | ~_GEN_70);
    wire         _GEN_80 = io_in_c_valid & (&io_in_c_bits_opcode) & ~reset;
    wire         _GEN_81 = io_in_c_valid & io_in_c_bits_opcode == 3'h0 & ~reset;
    wire         _GEN_82 = io_in_c_valid & io_in_c_bits_opcode == 3'h1 & ~reset;
    wire         _GEN_83 = io_in_c_valid & io_in_c_bits_opcode == 3'h2 & ~reset;
    wire         _GEN_84 = io_in_a_valid & (|a_first_counter) & ~reset;
    wire         _GEN_85 = io_in_d_valid & (|d_first_counter) & ~reset;
    wire         _GEN_86 = io_in_b_valid & (|b_first_counter) & ~reset;
    wire         _GEN_87 = io_in_c_valid & (|c_first_counter) & ~reset;
    wire [135:0] _GEN_88 = {128'h0, io_in_d_bits_source, 3'h0};
    ...
    wire         _GEN_89 = io_in_d_valid & d_first_1;
    wire         _GEN_90 = _GEN_89 & ~d_release_ack;
    wire         same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;
    wire [16:0]  _GEN_91 = {12'h0, io_in_d_bits_source};
    wire         _GEN_92 = _GEN_90 & same_cycle_resp & ~reset;
    wire         _GEN_93 = _GEN_90 & ~same_cycle_resp & ~reset;
    wire [7:0]   _GEN_94 = {4'h0, io_in_d_bits_size};
    ...
    wire         _GEN_95 = io_in_d_valid & d_first_2;
    wire         _GEN_96 = _GEN_95 & d_release_ack;
    ...
    wire [16:0]  _GEN_97 = inflight >> io_in_a_bits_source;
    wire [16:0]  _GEN_98 = inflight >> _GEN_91;
    wire [135:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_88;
    wire [31:0]  _d_clr_wo_ready_T = 32'h1 << _GEN_3;
    wire [16:0]  _GEN_99 = inflight_1 >> io_in_c_bits_source;
    wire [16:0]  _GEN_100 = inflight_1 >> _GEN_91;
    wire [135:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_88;
    wire [31:0]  _d_clr_wo_ready_T_1 = 32'h1 << _GEN_3;
    wire [7:0]   _GEN_101 = inflight_2 >> _GEN_8;
    wire [7:0]   _GEN_102 = (d_set | inflight_2) >> _GEN_10;
    always @(posedge clock) begin
      ...
      if (_GEN_61 & ~(~(io_in_b_bits_source[4]) & io_in_b_bits_source[3:0] < 4'h9 & (io_in_b_bits_address[32:13] == 20'h0 | ~(|_GEN_52) | ~(|_GEN_56) | {io_in_b_bits_address[32:21], _GEN_57[8:5], io_in_b_bits_address[15:12]} == 20'h0 | ~(|_GEN_55) | ~(|_GEN_53) | ~(|_GEN_60) | ~(|_GEN_54) | ~(|_GEN_58) | ~_GEN_59))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & ~(~(|_GEN_52) | ~(|_GEN_53) | {io_in_b_bits_address[32:13], ~(io_in_b_bits_address[12])} == 21'h0 | ~(|_GEN_54) | ~(|_GEN_55) | io_in_b_bits_address[32:12] == 21'h0 | ~(|_GEN_56) | {io_in_b_bits_address[32:21], _GEN_57} == 21'h0 | {io_in_b_bits_address[32:21], io_in_b_bits_address[20:12] ^ 9'h110} == 21'h0 | ~(|_GEN_58) | ~_GEN_59 | ~(|_GEN_60))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & {io_in_b_bits_source == 5'h10, io_in_b_bits_source == 5'h9 ? 4'h9 : 4'h0} != io_in_b_bits_source) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_61 & (|(io_in_b_bits_address[5:0]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_72 & io_in_c_bits_corrupt) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_78 & ~(_GEN_75 & (~(io_in_c_bits_source[4]) & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_1 | _source_ok_WIRE_2_2) & _GEN_77)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_78 & ~(~(io_in_c_bits_source[4]) & io_in_c_bits_source[3:0] < 4'h9 & _GEN_76 & _GEN_79)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_78 & (&(io_in_c_bits_param[2:1]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_78 & io_in_c_bits_corrupt) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_80 & ~(_GEN_75 & (~(io_in_c_bits_source[4]) & io_in_c_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2_1 | _source_ok_WIRE_2_2) & _GEN_77)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_80 & ~(~(io_in_c_bits_source[4]) & io_in_c_bits_source[3:0] < 4'h9 & _GEN_76 & _GEN_79)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'C' channel carries Release from a client which does not support Probe (connected at generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:41:55)\n    at Monitor.scala:42 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      ...
      if (_GEN_81 & (|io_in_c_bits_param)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_81 & io_in_c_bits_corrupt) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_82 & (|io_in_c_bits_param)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_84 & io_in_a_bits_opcode != opcode) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_84 & io_in_a_bits_param != param) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_84 & io_in_a_bits_size != size) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_84 & io_in_a_bits_source != source) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_84 & io_in_a_bits_address != address) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_85 & io_in_d_bits_opcode != opcode_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_85 & io_in_d_bits_param != param_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_85 & io_in_d_bits_size != size_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_85 & io_in_d_bits_source != source_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_85 & io_in_d_bits_sink != sink) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_85 & io_in_d_bits_denied != denied) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_86 & io_in_b_bits_param != param_2) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_86 & io_in_b_bits_source != source_2) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_86 & io_in_b_bits_address != address_1) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_87 & io_in_c_bits_opcode != opcode_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_87 & io_in_c_bits_param != param_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_87 & io_in_c_bits_size != size_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_87 & io_in_c_bits_source != source_3) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_87 & io_in_c_bits_address != address_2) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_2 & ~reset & _GEN_97[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_90 & ~reset & ~(_GEN_98[0] | same_cycle_resp)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_92 & ~(io_in_d_bits_opcode == casez_tmp | io_in_d_bits_opcode == casez_tmp_0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_92 & io_in_a_bits_size != io_in_d_bits_size) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_93 & ~(io_in_d_bits_opcode == casez_tmp_1 | io_in_d_bits_opcode == casez_tmp_2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper opcode response (connected at generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_93 & _GEN_94 != {1'h0, _a_size_lookup_T_1[7:1]}) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_89 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (~reset & ~(a_set_wo_ready != (_GEN_90 ? _d_clr_wo_ready_T[16:0] : 17'h0) | a_set_wo_ready == 17'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_6 & ~reset & _GEN_99[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_96 & ~reset & ~(_GEN_100[0] | same_cycle_resp_1)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_96 & same_cycle_resp_1 & ~reset & io_in_d_bits_size != io_in_c_bits_size) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_96 & ~same_cycle_resp_1 & ~reset & _GEN_94 != {1'h0, _c_size_lookup_T_1[7:1]}) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: 'D' channel contains improper response size (connected at generators/rocket-chip/src/main/scala/subsystem/SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if (_GEN_95 & c_first_1 & io_in_c_valid & io_in_c_bits_source == io_in_d_bits_source & d_release_ack & ~(io_in_c_bits_opcode == 3'h4 | io_in_c_bits_opcode == 3'h5) & ~reset & ~(~io_in_d_ready | io_in_c_ready)) begin
        if (`ASSERT_VERBOSE_COND_)
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");
        if (`STOP_COND_)
          $fatal;
      end
      if ((|c_set_wo_ready) & ~reset & c_set_wo_ready == (_GEN_96 ? _d_clr_wo_ready_T_1[16:0] : 17'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_7 & ~reset & _GEN_101[0]) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_9 & ~reset & ~(_GEN_102[0])) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [26:0]  _GEN_103 = {23'h0, io_in_d_bits_size};
  wire [26:0]  _d_first_beats1_decode_T_1 = 27'hFFF << _GEN_103;
  wire [26:0]  _d_first_beats1_decode_T_5 = 27'hFFF << _GEN_103;
  wire [26:0]  _d_first_beats1_decode_T_9 = 27'hFFF << _GEN_103;
  wire [26:0]  _d_first_beats1_decode_T_13 = 27'hFFF << _GEN_103;
  wire [26:0]  _c_first_beats1_decode_T_1 = 27'hFFF << _GEN_0;
  wire [26:0]  _c_first_beats1_decode_T_5 = 27'hFFF << _GEN_0;
  wire         _GEN_104 = _d_first_T_3 & d_first_1 & ~d_release_ack;
  wire [270:0] _GEN_105 = {263'h0, io_in_d_bits_source, 3'h0};
  wire         _GEN_106 = _d_first_T_3 & d_first_2 & d_release_ack;
  ...
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << _GEN_105;
  ...
  wire [270:0] _d_sizes_clr_T_11 = 271'hFF << _GEN_105;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_2 ? _a_set_T[16:0] : 17'h0)) & ~(_GEN_104 ? _d_clr_T[16:0] : 17'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_2 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_GEN_104 ? _d_opcodes_clr_T_5[67:0] : 68'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_2 ? _a_sizes_set_T_1[135:0] : 136'h0)) & ~(_GEN_104 ? _d_sizes_clr_T_5[135:0] : 136'h0);
      if (_a_first_T_1 | _d_first_T_3)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= (inflight_1 | (_GEN_6 ? _c_set_T[16:0] : 17'h0)) & ~(_GEN_106 ? _d_clr_T_1[16:0] : 17'h0);
      inflight_sizes_1 <= (inflight_sizes_1 | (_GEN_6 ? _c_sizes_set_T_1[135:0] : 136'h0)) & ~(_GEN_106 ? _d_sizes_clr_T_11[135:0] : 136'h0);
