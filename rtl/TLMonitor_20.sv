...
module TLMonitor_20(
  ...
  `ifndef SYNTHESIS
    ...
    wire          _GEN_19 = io_in_a_bits_source[7:4] == 4'h4;
    ...
    wire [1031:0] _GEN_42 = {1021'h0, io_in_d_bits_source, 3'h0};
    ...
    wire [128:0]  _GEN_45 = {121'h0, io_in_d_bits_source};
    ...
    wire [128:0]  _GEN_50 = inflight >> io_in_a_bits_source;
    wire [128:0]  _GEN_51 = inflight >> _GEN_45;
    wire [1031:0] _a_size_lookup_T_1 = inflight_sizes >> _GEN_42;
    wire [255:0]  _d_clr_wo_ready_T = 256'h1 << _GEN_2;
    wire [128:0]  _GEN_52 = inflight_1 >> _GEN_45;
    wire [1031:0] _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_42;
    always @(posedge clock) begin
      ...
      if (_GEN_5 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & _GEN_15)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_18 & ~((_GEN_6 & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 & _GEN_7) & _GEN_15)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_20 & ~(_GEN_4 & (_GEN_19 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_25 & ~(_GEN_4 & (_GEN_19 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_24)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_26 & ~(_GEN_4 & (_GEN_19 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_24)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_28 & ~(_GEN_4 & (_GEN_19 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_27)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_29 & ~(_GEN_4 & (_GEN_19 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_27)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_30 & ~(_GEN_4 & (_GEN_19 | _GEN_6 & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | ~(|(io_in_a_bits_source[7:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & _GEN_21)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(a_set_wo_ready != (_GEN_44 ? _d_clr_wo_ready_T[128:0] : 129'h0) | a_set_wo_ready == 129'h0)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  wire [2062:0] _GEN_54 = {2052'h0, io_in_d_bits_source, 3'h0};
  ...
  wire [2062:0] _d_sizes_clr_T_5 = 2063'hFF << _GEN_54;
  ...
  wire [2062:0] _d_sizes_clr_T_11 = 2063'hFF << _GEN_54;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_GEN_1 ? _a_set_T[128:0] : 129'h0)) & ~(_GEN_55 ? _d_clr_T[128:0] : 129'h0);
      inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[515:0] : 516'h0)) & ~(_GEN_55 ? _d_opcodes_clr_T_5[515:0] : 516'h0);
      inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[1031:0] : 1032'h0)) & ~(_GEN_55 ? _d_sizes_clr_T_5[1031:0] : 1032'h0);
      if (_a_first_T_1 | _d_first_T_2)
        watchdog <= 32'h0;
      else
        watchdog <= watchdog + 32'h1;
      inflight_1 <= inflight_1 & ~(_GEN_56 ? _d_clr_T_1[128:0] : 129'h0);
      inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_56 ? _d_sizes_clr_T_11[1031:0] : 1032'h0);
    end
