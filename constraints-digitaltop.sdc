...
set_clock_latency     1000 [get_clocks ${clk_name}_vir]       ;# Matching real clock latency
...
set new_clk1_name auto_prci_ctrl_domain_reset_setter_clock_in_member_allClocks_uncore_clock
set new_clk2_name debug_clock
